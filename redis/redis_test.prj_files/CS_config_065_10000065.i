...
configEnum maxmemory_policy_enum[] = {
    {"volatile-lru", ((0<<8)|(1<<0))},
    {"volatile-lfu", ((1<<8)|(1<<1))},
    {"volatile-random",(3<<8)},
    {"volatile-ttl",(2<<8)},
    {"allkeys-lru",((4<<8)|(1<<0)|(1<<2))},
    {"allkeys-lfu",((5<<8)|(1<<1)|(1<<2))},
    {"allkeys-random",((6<<8)|(1<<2))},
    {"noeviction",(7<<8)},
    {((void *)0), 0}
};
...
void loadServerConfigFromString(char *config) {
    ...
    for (i = 0; i < totlines; i++) {
        ...
        if (!strcasecmp(argv[0],"timeout") && argc == 2) {
            ...
            errno = 0;
            server.unixsocketperm = (mode_t)strtol(argv[1], ((void *)0), 8);
            ...
            if (server.syslog_facility == (-0x7fffffff - 1)) {
            ...
            loadServerConfig(argv[1],((void *)0));
            ...
            server.maxmemory = memtoll(argv[1],((void *)0));
        } else if (!strcasecmp(argv[0],"maxmemory-policy") && argc == 2) {
            server.maxmemory_policy =
                configEnumGetValue(maxmemory_policy_enum,argv[1]);
            if (server.maxmemory_policy == (-0x7fffffff - 1)) {
            ...
            server.proto_max_bulk_len = memtoll(argv[1],((void *)0));
        } else if ((!strcasecmp(argv[0],"client-query-buffer-limit")) && argc == 2) {
            server.client_max_querybuf_len = memtoll(argv[1],((void *)0));
                    ...
                    argc == 2)
        {
            ...
            long long size = memtoll(argv[1],((void *)0));
            if (size <= 0) {
            ...
            server.masteruser = argv[1][0] ? zstrdup(argv[1]) : ((void *)0);
        } else if (!strcasecmp(argv[0],"masterauth") && argc == 2) {
            zfree(server.masterauth);
            server.masterauth = argv[1][0] ? zstrdup(argv[1]) : ((void *)0);
                    ...
                    !strcasecmp(argv[0],"replica-lazy-flush")) && argc == 2)
        {
            ...
            if (server.config_hz < 1) server.config_hz = 1;
            if (server.config_hz > 500) server.config_hz = 500;
            ...
            if (server.aof_fsync == (-0x7fffffff - 1)) {
                   ...
                   argc == 2)
        {
            ...
            if (server.aof_rewrite_perc < 0) {
                ...
                goto loaderr;
                   ...
                   argc == 2)
        {
            server.aof_rewrite_min_size = memtoll(argv[1],((void *)0));
                   ...
                   argc == 2)
        {
            ...
            server.active_defrag_ignore_bytes = memtoll(argv[1], ((void *)0));
            ...
            server.active_defrag_max_scan_fields = strtoll(argv[1],((void *)0),10);
            if (server.active_defrag_max_scan_fields < 1) {
                err = "active-defrag-max-scan-fields must be positive";
                goto loaderr;
            }
        } else if (!strcasecmp(argv[0],"hash-max-ziplist-entries") && argc == 2) {
            server.hash_max_ziplist_entries = memtoll(argv[1], ((void *)0));
        } else if (!strcasecmp(argv[0],"hash-max-ziplist-value") && argc == 2) {
            server.hash_max_ziplist_value = memtoll(argv[1], ((void *)0));
        } else if (!strcasecmp(argv[0],"stream-node-max-bytes") && argc == 2) {
            server.stream_node_max_bytes = memtoll(argv[1], ((void *)0));
            ...
            server.set_max_intset_entries = memtoll(argv[1], ((void *)0));
        } else if (!strcasecmp(argv[0],"zset-max-ziplist-entries") && argc == 2) {
            server.zset_max_ziplist_entries = memtoll(argv[1], ((void *)0));
        } else if (!strcasecmp(argv[0],"zset-max-ziplist-value") && argc == 2) {
            server.zset_max_ziplist_value = memtoll(argv[1], ((void *)0));
        } else if (!strcasecmp(argv[0],"hll-sparse-max-bytes") && argc == 2) {
            server.hll_sparse_max_bytes = memtoll(argv[1], ((void *)0));
            ...
            ((retval == 0)?(void)0 : (_serverAssert("retval == DICT_OK","config.c",643),_exit(1)));
                    ...
                    argc == 2)
        {
            ...
            server.cluster_node_timeout = strtoll(argv[1],((void *)0),10);
                   ...
                   argc == 5)
        {
            ...
            hard = memtoll(argv[2],((void *)0));
            soft = memtoll(argv[3],((void *)0));
                    ...
                    !strcasecmp(argv[0],"min-replicas-max-lag")) && argc == 2)
        {
            ...
            if (server.supervised_mode == (-0x7fffffff - 1)) {
...
#define config_set_bool_field(_name,_var)     } else if (!strcasecmp(c->argv[2]->ptr,_name)) {         int yn = yesnotoi(o->ptr);         if (yn == -1) goto badfmt;         _var = yn;





#define config_set_numerical_field(_name,_var,min,max)     } else if (!strcasecmp(c->argv[2]->ptr,_name)) {         if (getLongLongFromObject(o,&ll) == C_ERR) goto badfmt;         if (min != LLONG_MIN && ll < min) goto badfmt;         if (max != LLONG_MAX && ll > max) goto badfmt;         _var = ll;
...
#define config_set_memory_field(_name,_var)     } else if (!strcasecmp(c->argv[2]->ptr,_name)) {         ll = memtoll(o->ptr,&err);         if (err || ll < 0) goto badfmt;         _var = ll;





#define config_set_enum_field(_name,_var,_enumvar)     } else if (!strcasecmp(c->argv[2]->ptr,_name)) {         int enumval = configEnumGetValue(_enumvar,o->ptr);         if (enumval == INT_MIN) goto badfmt;         _var = enumval;
...
#define config_set_special_field_with_alias(_name1,_name2)     } else if (!strcasecmp(c->argv[2]->ptr,_name1) ||                !strcasecmp(c->argv[2]->ptr,_name2)) {
...
void configSetCommand(client *c) {
    ...
    long long ll;
    int err;
    (((c->argv[2]->encoding == 0 || c->argv[2]->encoding == 8))?(void)0 : (_serverAssertWithInfo(c,c->argv[2],"sdsEncodedObject(c->argv[2])","config.c",940),_exit(1)));
    (((c->argv[3]->encoding == 0 || c->argv[3]->encoding == 8))?(void)0 : (_serverAssertWithInfo(c,c->argv[3],"sdsEncodedObject(c->argv[3])","config.c",941),_exit(1)));
    o = c->argv[3];

    if (0) {  

     
    } else if (!strcasecmp(c->argv[2]->ptr,"dbfilename")) { {
        ...
        if (sdslen(o->ptr) > 512) goto badfmt;
        ...
        ACLSetUser(DefaultUser,aclop,sdslen(aclop));
        sdsfree(aclop);
    } } else if (!strcasecmp(c->argv[2]->ptr,"masteruser")) { {
        zfree(server.masteruser);
        server.masteruser = ((char*)o->ptr)[0] ? zstrdup(o->ptr) : ((void *)0);
    } } else if (!strcasecmp(c->argv[2]->ptr,"masterauth")) { {
        zfree(server.masterauth);
        server.masterauth = ((char*)o->ptr)[0] ? zstrdup(o->ptr) : ((void *)0);
    } } else if (!strcasecmp(c->argv[2]->ptr,"cluster-announce-ip")) { {
        zfree(server.cluster_announce_ip);
        server.cluster_announce_ip = ((char*)o->ptr)[0] ? zstrdup(o->ptr) : ((void *)0);
    } } else if (!strcasecmp(c->argv[2]->ptr,"maxclients")) { {
        int orig_value = server.maxclients;

        if (getLongLongFromObject(o,&ll) == -1 || ll < 1) goto badfmt;
        ...
        if (ll > orig_value) {
            ...
            if ((unsigned int) aeGetSetSize(server.el) <
                server.maxclients + (32+96))
            {
                if (aeResizeSetSize(server.el,
                    server.maxclients + (32+96)) == -1)
                {
        ...
        if (enable == 0 && server.aof_state != 0) {
            stopAppendOnly();
        } else if (enable && server.aof_state == 0) {
            if (startAppendOnly() == -1) {
                addReplyError(c,
        ...
        for (j = 0; j < vlen; j += 2) {
            ...
            seconds = strtoll(v[j],((void *)0),10);
            changes = strtoll(v[j+1],((void *)0),10);
            appendServerSaveParams(seconds, changes);
        }
        sdsfreesplitres(v,vlen);
        ...
        for (j = 0; j < vlen; j += 4) {
            ...
            hard = memtoll(v[j+1],((void *)0));
            soft = memtoll(v[j+2],((void *)0));
            soft_seconds = strtoll(v[j+3],((void *)0),10);
        ...
        server.notify_keyspace_events = flags;
    } } else if (!strcasecmp(c->argv[2]->ptr,"slave-announce-ip") || !strcasecmp(c->argv[2]->ptr,"replica-announce-ip")) {

    {
        zfree(server.slave_announce_ip);
        server.slave_announce_ip = ((char*)o->ptr)[0] ? zstrdup(o->ptr) : ((void *)0);

    
 
    } } else if (!strcasecmp(c->argv[2]->ptr,"rdbcompression")) { int yn = yesnotoi(o->ptr); if (yn == -1) goto badfmt; server . rdb_compression = yn; {

    } } else if (!strcasecmp(c->argv[2]->ptr,"repl-disable-tcp-nodelay")) { int yn = yesnotoi(o->ptr); if (yn == -1) goto badfmt; server . repl_disable_tcp_nodelay = yn; {

    } } else if (!strcasecmp(c->argv[2]->ptr,"repl-diskless-sync")) { int yn = yesnotoi(o->ptr); if (yn == -1) goto badfmt; server . repl_diskless_sync = yn; {

    } } else if (!strcasecmp(c->argv[2]->ptr,"cluster-require-full-coverage")) { int yn = yesnotoi(o->ptr); if (yn == -1) goto badfmt; server . cluster_require_full_coverage = yn; {

    } } else if (!strcasecmp(c->argv[2]->ptr,"cluster-slave-no-failover")) { int yn = yesnotoi(o->ptr); if (yn == -1) goto badfmt; server . cluster_slave_no_failover = yn; {

    } } else if (!strcasecmp(c->argv[2]->ptr,"cluster-replica-no-failover")) { int yn = yesnotoi(o->ptr); if (yn == -1) goto badfmt; server . cluster_slave_no_failover = yn; {

    } } else if (!strcasecmp(c->argv[2]->ptr,"aof-rewrite-incremental-fsync")) { int yn = yesnotoi(o->ptr); if (yn == -1) goto badfmt; server . aof_rewrite_incremental_fsync = yn; {

    } } else if (!strcasecmp(c->argv[2]->ptr,"rdb-save-incremental-fsync")) { int yn = yesnotoi(o->ptr); if (yn == -1) goto badfmt; server . rdb_save_incremental_fsync = yn; {

    } } else if (!strcasecmp(c->argv[2]->ptr,"aof-load-truncated")) { int yn = yesnotoi(o->ptr); if (yn == -1) goto badfmt; server . aof_load_truncated = yn; {

    } } else if (!strcasecmp(c->argv[2]->ptr,"aof-use-rdb-preamble")) { int yn = yesnotoi(o->ptr); if (yn == -1) goto badfmt; server . aof_use_rdb_preamble = yn; {

    } } else if (!strcasecmp(c->argv[2]->ptr,"slave-serve-stale-data")) { int yn = yesnotoi(o->ptr); if (yn == -1) goto badfmt; server . repl_serve_stale_data = yn; {

    } } else if (!strcasecmp(c->argv[2]->ptr,"replica-serve-stale-data")) { int yn = yesnotoi(o->ptr); if (yn == -1) goto badfmt; server . repl_serve_stale_data = yn; {

    } } else if (!strcasecmp(c->argv[2]->ptr,"slave-read-only")) { int yn = yesnotoi(o->ptr); if (yn == -1) goto badfmt; server . repl_slave_ro = yn; {

    } } else if (!strcasecmp(c->argv[2]->ptr,"replica-read-only")) { int yn = yesnotoi(o->ptr); if (yn == -1) goto badfmt; server . repl_slave_ro = yn; {

    } } else if (!strcasecmp(c->argv[2]->ptr,"slave-ignore-maxmemory")) { int yn = yesnotoi(o->ptr); if (yn == -1) goto badfmt; server . repl_slave_ignore_maxmemory = yn; {

    } } else if (!strcasecmp(c->argv[2]->ptr,"replica-ignore-maxmemory")) { int yn = yesnotoi(o->ptr); if (yn == -1) goto badfmt; server . repl_slave_ignore_maxmemory = yn; {

    } } else if (!strcasecmp(c->argv[2]->ptr,"activerehashing")) { int yn = yesnotoi(o->ptr); if (yn == -1) goto badfmt; server . activerehashing = yn; {

    } } else if (!strcasecmp(c->argv[2]->ptr,"activedefrag")) { int yn = yesnotoi(o->ptr); if (yn == -1) goto badfmt; server . active_defrag_enabled = yn; {
# 1155 "config.c"
    } } else if (!strcasecmp(c->argv[2]->ptr,"protected-mode")) { int yn = yesnotoi(o->ptr); if (yn == -1) goto badfmt; server . protected_mode = yn; {

    } } else if (!strcasecmp(c->argv[2]->ptr,"gopher-enabled")) { int yn = yesnotoi(o->ptr); if (yn == -1) goto badfmt; server . gopher_enabled = yn; {

    } } else if (!strcasecmp(c->argv[2]->ptr,"stop-writes-on-bgsave-error")) { int yn = yesnotoi(o->ptr); if (yn == -1) goto badfmt; server . stop_writes_on_bgsave_err = yn; {

    } } else if (!strcasecmp(c->argv[2]->ptr,"lazyfree-lazy-eviction")) { int yn = yesnotoi(o->ptr); if (yn == -1) goto badfmt; server . lazyfree_lazy_eviction = yn; {

    } } else if (!strcasecmp(c->argv[2]->ptr,"lazyfree-lazy-expire")) { int yn = yesnotoi(o->ptr); if (yn == -1) goto badfmt; server . lazyfree_lazy_expire = yn; {

    } } else if (!strcasecmp(c->argv[2]->ptr,"lazyfree-lazy-server-del")) { int yn = yesnotoi(o->ptr); if (yn == -1) goto badfmt; server . lazyfree_lazy_server_del = yn; {

    } } else if (!strcasecmp(c->argv[2]->ptr,"slave-lazy-flush")) { int yn = yesnotoi(o->ptr); if (yn == -1) goto badfmt; server . repl_slave_lazy_flush = yn; {

    } } else if (!strcasecmp(c->argv[2]->ptr,"replica-lazy-flush")) { int yn = yesnotoi(o->ptr); if (yn == -1) goto badfmt; server . repl_slave_lazy_flush = yn; {

    } } else if (!strcasecmp(c->argv[2]->ptr,"no-appendfsync-on-rewrite")) { int yn = yesnotoi(o->ptr); if (yn == -1) goto badfmt; server . aof_no_fsync_on_rewrite = yn; {

    } } else if (!strcasecmp(c->argv[2]->ptr,"dynamic-hz")) { int yn = yesnotoi(o->ptr); if (yn == -1) goto badfmt; server . dynamic_hz = yn; {


    
 
    } } else if (!strcasecmp(c->argv[2]->ptr,"tcp-keepalive")) { if (getLongLongFromObject(o,&ll) == -1) goto badfmt; if (0 != (-0x7fffffffffffffffLL - 1LL) && ll < 0) goto badfmt; if (0x7fffffff != 0x7fffffffffffffffLL && ll > 0x7fffffff) goto badfmt; server . tcpkeepalive = ll; {

    } } else if (!strcasecmp(c->argv[2]->ptr,"maxmemory-samples")) { if (getLongLongFromObject(o,&ll) == -1) goto badfmt; if (1 != (-0x7fffffffffffffffLL - 1LL) && ll < 1) goto badfmt; if (0x7fffffff != 0x7fffffffffffffffLL && ll > 0x7fffffff) goto badfmt; server . maxmemory_samples = ll; {

    } } else if (!strcasecmp(c->argv[2]->ptr,"lfu-log-factor")) { if (getLongLongFromObject(o,&ll) == -1) goto badfmt; if (0 != (-0x7fffffffffffffffLL - 1LL) && ll < 0) goto badfmt; if (0x7fffffff != 0x7fffffffffffffffLL && ll > 0x7fffffff) goto badfmt; server . lfu_log_factor = ll; {

    } } else if (!strcasecmp(c->argv[2]->ptr,"lfu-decay-time")) { if (getLongLongFromObject(o,&ll) == -1) goto badfmt; if (0 != (-0x7fffffffffffffffLL - 1LL) && ll < 0) goto badfmt; if (0x7fffffff != 0x7fffffffffffffffLL && ll > 0x7fffffff) goto badfmt; server . lfu_decay_time = ll; {

    } } else if (!strcasecmp(c->argv[2]->ptr,"timeout")) { if (getLongLongFromObject(o,&ll) == -1) goto badfmt; if (0 != (-0x7fffffffffffffffLL - 1LL) && ll < 0) goto badfmt; if (0x7fffffff != 0x7fffffffffffffffLL && ll > 0x7fffffff) goto badfmt; server . maxidletime = ll; {

    } } else if (!strcasecmp(c->argv[2]->ptr,"active-defrag-threshold-lower")) { if (getLongLongFromObject(o,&ll) == -1) goto badfmt; if (0 != (-0x7fffffffffffffffLL - 1LL) && ll < 0) goto badfmt; if (1000 != 0x7fffffffffffffffLL && ll > 1000) goto badfmt; server . active_defrag_threshold_lower = ll; {

    } } else if (!strcasecmp(c->argv[2]->ptr,"active-defrag-threshold-upper")) { if (getLongLongFromObject(o,&ll) == -1) goto badfmt; if (0 != (-0x7fffffffffffffffLL - 1LL) && ll < 0) goto badfmt; if (1000 != 0x7fffffffffffffffLL && ll > 1000) goto badfmt; server . active_defrag_threshold_upper = ll; {

    } } else if (!strcasecmp(c->argv[2]->ptr,"active-defrag-ignore-bytes")) { ll = memtoll(o->ptr,&err); if (err || ll < 0) goto badfmt; server . active_defrag_ignore_bytes = ll; {

    } } else if (!strcasecmp(c->argv[2]->ptr,"active-defrag-cycle-min")) { if (getLongLongFromObject(o,&ll) == -1) goto badfmt; if (1 != (-0x7fffffffffffffffLL - 1LL) && ll < 1) goto badfmt; if (99 != 0x7fffffffffffffffLL && ll > 99) goto badfmt; server . active_defrag_cycle_min = ll; {

    } } else if (!strcasecmp(c->argv[2]->ptr,"active-defrag-cycle-max")) { if (getLongLongFromObject(o,&ll) == -1) goto badfmt; if (1 != (-0x7fffffffffffffffLL - 1LL) && ll < 1) goto badfmt; if (99 != 0x7fffffffffffffffLL && ll > 99) goto badfmt; server . active_defrag_cycle_max = ll; {

    } } else if (!strcasecmp(c->argv[2]->ptr,"active-defrag-max-scan-fields")) { if (getLongLongFromObject(o,&ll) == -1) goto badfmt; if (1 != (-0x7fffffffffffffffLL - 1LL) && ll < 1) goto badfmt; if (0x7fffffffffffffffL != 0x7fffffffffffffffLL && ll > 0x7fffffffffffffffL) goto badfmt; server . active_defrag_max_scan_fields = ll; {

    } } else if (!strcasecmp(c->argv[2]->ptr,"auto-aof-rewrite-percentage")) { if (getLongLongFromObject(o,&ll) == -1) goto badfmt; if (0 != (-0x7fffffffffffffffLL - 1LL) && ll < 0) goto badfmt; if (0x7fffffff != 0x7fffffffffffffffLL && ll > 0x7fffffff) goto badfmt; server . aof_rewrite_perc = ll;{

    } } else if (!strcasecmp(c->argv[2]->ptr,"hash-max-ziplist-entries")) { if (getLongLongFromObject(o,&ll) == -1) goto badfmt; if (0 != (-0x7fffffffffffffffLL - 1LL) && ll < 0) goto badfmt; if (0x7fffffffffffffffL != 0x7fffffffffffffffLL && ll > 0x7fffffffffffffffL) goto badfmt; server . hash_max_ziplist_entries = ll; {

    } } else if (!strcasecmp(c->argv[2]->ptr,"hash-max-ziplist-value")) { if (getLongLongFromObject(o,&ll) == -1) goto badfmt; if (0 != (-0x7fffffffffffffffLL - 1LL) && ll < 0) goto badfmt; if (0x7fffffffffffffffL != 0x7fffffffffffffffLL && ll > 0x7fffffffffffffffL) goto badfmt; server . hash_max_ziplist_value = ll; {

    } } else if (!strcasecmp(c->argv[2]->ptr,"stream-node-max-bytes")) { if (getLongLongFromObject(o,&ll) == -1) goto badfmt; if (0 != (-0x7fffffffffffffffLL - 1LL) && ll < 0) goto badfmt; if (0x7fffffffffffffffL != 0x7fffffffffffffffLL && ll > 0x7fffffffffffffffL) goto badfmt; server . stream_node_max_bytes = ll; {

    } } else if (!strcasecmp(c->argv[2]->ptr,"stream-node-max-entries")) { if (getLongLongFromObject(o,&ll) == -1) goto badfmt; if (0 != (-0x7fffffffffffffffLL - 1LL) && ll < 0) goto badfmt; if (0x7fffffffffffffffLL != 0x7fffffffffffffffLL && ll > 0x7fffffffffffffffLL) goto badfmt; server . stream_node_max_entries = ll; {

    } } else if (!strcasecmp(c->argv[2]->ptr,"list-max-ziplist-size")) { if (getLongLongFromObject(o,&ll) == -1) goto badfmt; if ((-0x7fffffff - 1) != (-0x7fffffffffffffffLL - 1LL) && ll < (-0x7fffffff - 1)) goto badfmt; if (0x7fffffff != 0x7fffffffffffffffLL && ll > 0x7fffffff) goto badfmt; server . list_max_ziplist_size = ll; {

    } } else if (!strcasecmp(c->argv[2]->ptr,"list-compress-depth")) { if (getLongLongFromObject(o,&ll) == -1) goto badfmt; if (0 != (-0x7fffffffffffffffLL - 1LL) && ll < 0) goto badfmt; if (0x7fffffff != 0x7fffffffffffffffLL && ll > 0x7fffffff) goto badfmt; server . list_compress_depth = ll; {

    } } else if (!strcasecmp(c->argv[2]->ptr,"set-max-intset-entries")) { if (getLongLongFromObject(o,&ll) == -1) goto badfmt; if (0 != (-0x7fffffffffffffffLL - 1LL) && ll < 0) goto badfmt; if (0x7fffffffffffffffL != 0x7fffffffffffffffLL && ll > 0x7fffffffffffffffL) goto badfmt; server . set_max_intset_entries = ll; {

    } } else if (!strcasecmp(c->argv[2]->ptr,"zset-max-ziplist-entries")) { if (getLongLongFromObject(o,&ll) == -1) goto badfmt; if (0 != (-0x7fffffffffffffffLL - 1LL) && ll < 0) goto badfmt; if (0x7fffffffffffffffL != 0x7fffffffffffffffLL && ll > 0x7fffffffffffffffL) goto badfmt; server . zset_max_ziplist_entries = ll; {

    } } else if (!strcasecmp(c->argv[2]->ptr,"zset-max-ziplist-value")) { if (getLongLongFromObject(o,&ll) == -1) goto badfmt; if (0 != (-0x7fffffffffffffffLL - 1LL) && ll < 0) goto badfmt; if (0x7fffffffffffffffL != 0x7fffffffffffffffLL && ll > 0x7fffffffffffffffL) goto badfmt; server . zset_max_ziplist_value = ll; {

    } } else if (!strcasecmp(c->argv[2]->ptr,"hll-sparse-max-bytes")) { if (getLongLongFromObject(o,&ll) == -1) goto badfmt; if (0 != (-0x7fffffffffffffffLL - 1LL) && ll < 0) goto badfmt; if (0x7fffffffffffffffL != 0x7fffffffffffffffLL && ll > 0x7fffffffffffffffL) goto badfmt; server . hll_sparse_max_bytes = ll; {

    } } else if (!strcasecmp(c->argv[2]->ptr,"lua-time-limit")) { if (getLongLongFromObject(o,&ll) == -1) goto badfmt; if (0 != (-0x7fffffffffffffffLL - 1LL) && ll < 0) goto badfmt; if (0x7fffffffffffffffL != 0x7fffffffffffffffLL && ll > 0x7fffffffffffffffL) goto badfmt; server . lua_time_limit = ll; {

    } } else if (!strcasecmp(c->argv[2]->ptr,"slowlog-log-slower-than")) { if (getLongLongFromObject(o,&ll) == -1) goto badfmt; if (-1 != (-0x7fffffffffffffffLL - 1LL) && ll < -1) goto badfmt; if (0x7fffffffffffffffLL != 0x7fffffffffffffffLL && ll > 0x7fffffffffffffffLL) goto badfmt; server . slowlog_log_slower_than = ll; {

    } } else if (!strcasecmp(c->argv[2]->ptr,"slowlog-max-len")) { if (getLongLongFromObject(o,&ll) == -1) goto badfmt; if (0 != (-0x7fffffffffffffffLL - 1LL) && ll < 0) goto badfmt; if (0x7fffffffffffffffL != 0x7fffffffffffffffLL && ll > 0x7fffffffffffffffL) goto badfmt; ll = ll; {

       
        server.slowlog_max_len = (unsigned long)ll;
    } } else if (!strcasecmp(c->argv[2]->ptr,"latency-monitor-threshold")) { if (getLongLongFromObject(o,&ll) == -1) goto badfmt; if (0 != (-0x7fffffffffffffffLL - 1LL) && ll < 0) goto badfmt; if (0x7fffffffffffffffLL != 0x7fffffffffffffffLL && ll > 0x7fffffffffffffffLL) goto badfmt; server . latency_monitor_threshold = ll;{

    } } else if (!strcasecmp(c->argv[2]->ptr,"repl-ping-slave-period")) { if (getLongLongFromObject(o,&ll) == -1) goto badfmt; if (1 != (-0x7fffffffffffffffLL - 1LL) && ll < 1) goto badfmt; if (0x7fffffff != 0x7fffffffffffffffLL && ll > 0x7fffffff) goto badfmt; server . repl_ping_slave_period = ll; {

    } } else if (!strcasecmp(c->argv[2]->ptr,"repl-ping-replica-period")) { if (getLongLongFromObject(o,&ll) == -1) goto badfmt; if (1 != (-0x7fffffffffffffffLL - 1LL) && ll < 1) goto badfmt; if (0x7fffffff != 0x7fffffffffffffffLL && ll > 0x7fffffff) goto badfmt; server . repl_ping_slave_period = ll; {

    } } else if (!strcasecmp(c->argv[2]->ptr,"repl-timeout")) { if (getLongLongFromObject(o,&ll) == -1) goto badfmt; if (1 != (-0x7fffffffffffffffLL - 1LL) && ll < 1) goto badfmt; if (0x7fffffff != 0x7fffffffffffffffLL && ll > 0x7fffffff) goto badfmt; server . repl_timeout = ll; {

    } } else if (!strcasecmp(c->argv[2]->ptr,"repl-backlog-ttl")) { if (getLongLongFromObject(o,&ll) == -1) goto badfmt; if (0 != (-0x7fffffffffffffffLL - 1LL) && ll < 0) goto badfmt; if (0x7fffffffffffffffL != 0x7fffffffffffffffLL && ll > 0x7fffffffffffffffL) goto badfmt; server . repl_backlog_time_limit = ll; {

    } } else if (!strcasecmp(c->argv[2]->ptr,"repl-diskless-sync-delay")) { if (getLongLongFromObject(o,&ll) == -1) goto badfmt; if (0 != (-0x7fffffffffffffffLL - 1LL) && ll < 0) goto badfmt; if (0x7fffffff != 0x7fffffffffffffffLL && ll > 0x7fffffff) goto badfmt; server . repl_diskless_sync_delay = ll; {

    } } else if (!strcasecmp(c->argv[2]->ptr,"slave-priority")) { if (getLongLongFromObject(o,&ll) == -1) goto badfmt; if (0 != (-0x7fffffffffffffffLL - 1LL) && ll < 0) goto badfmt; if (0x7fffffff != 0x7fffffffffffffffLL && ll > 0x7fffffff) goto badfmt; server . slave_priority = ll; {

    } } else if (!strcasecmp(c->argv[2]->ptr,"replica-priority")) { if (getLongLongFromObject(o,&ll) == -1) goto badfmt; if (0 != (-0x7fffffffffffffffLL - 1LL) && ll < 0) goto badfmt; if (0x7fffffff != 0x7fffffffffffffffLL && ll > 0x7fffffff) goto badfmt; server . slave_priority = ll; {

    } } else if (!strcasecmp(c->argv[2]->ptr,"slave-announce-port")) { if (getLongLongFromObject(o,&ll) == -1) goto badfmt; if (0 != (-0x7fffffffffffffffLL - 1LL) && ll < 0) goto badfmt; if (65535 != 0x7fffffffffffffffLL && ll > 65535) goto badfmt; server . slave_announce_port = ll; {

    } } else if (!strcasecmp(c->argv[2]->ptr,"replica-announce-port")) { if (getLongLongFromObject(o,&ll) == -1) goto badfmt; if (0 != (-0x7fffffffffffffffLL - 1LL) && ll < 0) goto badfmt; if (65535 != 0x7fffffffffffffffLL && ll > 65535) goto badfmt; server . slave_announce_port = ll; {

    } } else if (!strcasecmp(c->argv[2]->ptr,"min-slaves-to-write")) { if (getLongLongFromObject(o,&ll) == -1) goto badfmt; if (0 != (-0x7fffffffffffffffLL - 1LL) && ll < 0) goto badfmt; if (0x7fffffff != 0x7fffffffffffffffLL && ll > 0x7fffffff) goto badfmt; server . repl_min_slaves_to_write = ll; {

        refreshGoodSlavesCount();
    } } else if (!strcasecmp(c->argv[2]->ptr,"min-replicas-to-write")) { if (getLongLongFromObject(o,&ll) == -1) goto badfmt; if (0 != (-0x7fffffffffffffffLL - 1LL) && ll < 0) goto badfmt; if (0x7fffffff != 0x7fffffffffffffffLL && ll > 0x7fffffff) goto badfmt; server . repl_min_slaves_to_write = ll; {

        refreshGoodSlavesCount();
    } } else if (!strcasecmp(c->argv[2]->ptr,"min-slaves-max-lag")) { if (getLongLongFromObject(o,&ll) == -1) goto badfmt; if (0 != (-0x7fffffffffffffffLL - 1LL) && ll < 0) goto badfmt; if (0x7fffffff != 0x7fffffffffffffffLL && ll > 0x7fffffff) goto badfmt; server . repl_min_slaves_max_lag = ll; {

        refreshGoodSlavesCount();
    } } else if (!strcasecmp(c->argv[2]->ptr,"min-replicas-max-lag")) { if (getLongLongFromObject(o,&ll) == -1) goto badfmt; if (0 != (-0x7fffffffffffffffLL - 1LL) && ll < 0) goto badfmt; if (0x7fffffff != 0x7fffffffffffffffLL && ll > 0x7fffffff) goto badfmt; server . repl_min_slaves_max_lag = ll; {

        refreshGoodSlavesCount();
    } } else if (!strcasecmp(c->argv[2]->ptr,"cluster-node-timeout")) { if (getLongLongFromObject(o,&ll) == -1) goto badfmt; if (0 != (-0x7fffffffffffffffLL - 1LL) && ll < 0) goto badfmt; if (0x7fffffffffffffffLL != 0x7fffffffffffffffLL && ll > 0x7fffffffffffffffLL) goto badfmt; server . cluster_node_timeout = ll; {

    } } else if (!strcasecmp(c->argv[2]->ptr,"cluster-announce-port")) { if (getLongLongFromObject(o,&ll) == -1) goto badfmt; if (0 != (-0x7fffffffffffffffLL - 1LL) && ll < 0) goto badfmt; if (65535 != 0x7fffffffffffffffLL && ll > 65535) goto badfmt; server . cluster_announce_port = ll; {

    } } else if (!strcasecmp(c->argv[2]->ptr,"cluster-announce-bus-port")) { if (getLongLongFromObject(o,&ll) == -1) goto badfmt; if (0 != (-0x7fffffffffffffffLL - 1LL) && ll < 0) goto badfmt; if (65535 != 0x7fffffffffffffffLL && ll > 65535) goto badfmt; server . cluster_announce_bus_port = ll; {

    } } else if (!strcasecmp(c->argv[2]->ptr,"cluster-migration-barrier")) { if (getLongLongFromObject(o,&ll) == -1) goto badfmt; if (0 != (-0x7fffffffffffffffLL - 1LL) && ll < 0) goto badfmt; if (0x7fffffff != 0x7fffffffffffffffLL && ll > 0x7fffffff) goto badfmt; server . cluster_migration_barrier = ll;{

    } } else if (!strcasecmp(c->argv[2]->ptr,"cluster-slave-validity-factor")) { if (getLongLongFromObject(o,&ll) == -1) goto badfmt; if (0 != (-0x7fffffffffffffffLL - 1LL) && ll < 0) goto badfmt; if (0x7fffffff != 0x7fffffffffffffffLL && ll > 0x7fffffff) goto badfmt; server . cluster_slave_validity_factor = ll; {

    } } else if (!strcasecmp(c->argv[2]->ptr,"cluster-replica-validity-factor")) { if (getLongLongFromObject(o,&ll) == -1) goto badfmt; if (0 != (-0x7fffffffffffffffLL - 1LL) && ll < 0) goto badfmt; if (0x7fffffff != 0x7fffffffffffffffLL && ll > 0x7fffffff) goto badfmt; server . cluster_slave_validity_factor = ll; {

    } } else if (!strcasecmp(c->argv[2]->ptr,"hz")) { if (getLongLongFromObject(o,&ll) == -1) goto badfmt; if (0 != (-0x7fffffffffffffffLL - 1LL) && ll < 0) goto badfmt; if (0x7fffffff != 0x7fffffffffffffffLL && ll > 0x7fffffff) goto badfmt; server . config_hz = ll; {

        
 
        if (server.config_hz < 1) server.config_hz = 1;
        if (server.config_hz > 500) server.config_hz = 500;
    } } else if (!strcasecmp(c->argv[2]->ptr,"watchdog-period")) { if (getLongLongFromObject(o,&ll) == -1) goto badfmt; if (0 != (-0x7fffffffffffffffLL - 1LL) && ll < 0) goto badfmt; if (0x7fffffff != 0x7fffffffffffffffLL && ll > 0x7fffffff) goto badfmt; ll = ll; {
    ...
    } } else if (!strcasecmp(c->argv[2]->ptr,"maxmemory")) { ll = memtoll(o->ptr,&err); if (err || ll < 0) goto badfmt; server . maxmemory = ll; {
        if (server.maxmemory) {
            if (server.maxmemory < zmalloc_used_memory()) {
                serverLog(3,"WARNING: the new maxmemory value set via CONFIG SET is smaller than the current memory usage. This will result in key eviction and/or the inability to accept new write commands depending on the maxmemory-policy.");
            }
            freeMemoryIfNeededAndSafe();
        }
    } } else if (!strcasecmp(c->argv[2]->ptr,"proto-max-bulk-len")) { ll = memtoll(o->ptr,&err); if (err || ll < 0) goto badfmt; server . proto_max_bulk_len = ll; {

    } } else if (!strcasecmp(c->argv[2]->ptr,"client-query-buffer-limit")) { ll = memtoll(o->ptr,&err); if (err || ll < 0) goto badfmt; server . client_max_querybuf_len = ll; {

    } } else if (!strcasecmp(c->argv[2]->ptr,"repl-backlog-size")) { ll = memtoll(o->ptr,&err); if (err || ll < 0) goto badfmt; ll = ll; {
        resizeReplicationBacklog(ll);
    } } else if (!strcasecmp(c->argv[2]->ptr,"auto-aof-rewrite-min-size")) { ll = memtoll(o->ptr,&err); if (err || ll < 0) goto badfmt; ll = ll; {
        server.aof_rewrite_min_size = ll;

    
 
    } } else if (!strcasecmp(c->argv[2]->ptr,"loglevel")) { int enumval = configEnumGetValue(loglevel_enum,o->ptr); if (enumval == (-0x7fffffff - 1)) goto badfmt; server . verbosity = enumval; {

    } } else if (!strcasecmp(c->argv[2]->ptr,"maxmemory-policy")) { int enumval = configEnumGetValue(maxmemory_policy_enum,o->ptr); if (enumval == (-0x7fffffff - 1)) goto badfmt; server . maxmemory_policy = enumval; {

    } } else if (!strcasecmp(c->argv[2]->ptr,"appendfsync")) { int enumval = configEnumGetValue(aof_fsync_enum,o->ptr); if (enumval == (-0x7fffffff - 1)) goto badfmt; server . aof_fsync = enumval; {
...
#define config_get_string_field(_name,_var) do {     if (stringmatch(pattern,_name,1)) {         addReplyBulkCString(c,_name);         addReplyBulkCString(c,_var ? _var : "");         matches++;     } } while(0);
# 1342 "config.c"

#define config_get_bool_field(_name,_var) do {     if (stringmatch(pattern,_name,1)) {         addReplyBulkCString(c,_name);         addReplyBulkCString(c,_var ? "yes" : "no");         matches++;     } } while(0);
# 1350 "config.c"

#define config_get_numerical_field(_name,_var) do {     if (stringmatch(pattern,_name,1)) {         ll2string(buf,sizeof(buf),_var);         addReplyBulkCString(c,_name);         addReplyBulkCString(c,buf);         matches++;     } } while(0);
# 1359 "config.c"

#define config_get_enum_field(_name,_var,_enumvar) do {     if (stringmatch(pattern,_name,1)) {         addReplyBulkCString(c,_name);         addReplyBulkCString(c,configEnumGetNameOrUnknown(_enumvar,_var));         matches++;     } } while(0);
# 1367 "config.c"
...
void configGetCommand(client *c) {
    ...
    char buf[128];
    int matches = 0;
    (((o->encoding == 0 || o->encoding == 8))?(void)0 : (_serverAssertWithInfo(c,o,"sdsEncodedObject(o)","config.c",1374),_exit(1)));

     
    do { if (stringmatch(pattern,"dbfilename",1)) { addReplyBulkCString(c,"dbfilename"); addReplyBulkCString(c,server . rdb_filename ? server . rdb_filename : ""); matches++; } } while(0);;
    do { if (stringmatch(pattern,"masteruser",1)) { addReplyBulkCString(c,"masteruser"); addReplyBulkCString(c,server . masteruser ? server . masteruser : ""); matches++; } } while(0);;
    do { if (stringmatch(pattern,"masterauth",1)) { addReplyBulkCString(c,"masterauth"); addReplyBulkCString(c,server . masterauth ? server . masterauth : ""); matches++; } } while(0);;
    do { if (stringmatch(pattern,"cluster-announce-ip",1)) { addReplyBulkCString(c,"cluster-announce-ip"); addReplyBulkCString(c,server . cluster_announce_ip ? server . cluster_announce_ip : ""); matches++; } } while(0);;
    do { if (stringmatch(pattern,"unixsocket",1)) { addReplyBulkCString(c,"unixsocket"); addReplyBulkCString(c,server . unixsocket ? server . unixsocket : ""); matches++; } } while(0);;
    do { if (stringmatch(pattern,"logfile",1)) { addReplyBulkCString(c,"logfile"); addReplyBulkCString(c,server . logfile ? server . logfile : ""); matches++; } } while(0);;
    do { if (stringmatch(pattern,"aclfile",1)) { addReplyBulkCString(c,"aclfile"); addReplyBulkCString(c,server . acl_filename ? server . acl_filename : ""); matches++; } } while(0);;
    do { if (stringmatch(pattern,"pidfile",1)) { addReplyBulkCString(c,"pidfile"); addReplyBulkCString(c,server . pidfile ? server . pidfile : ""); matches++; } } while(0);;
    do { if (stringmatch(pattern,"slave-announce-ip",1)) { addReplyBulkCString(c,"slave-announce-ip"); addReplyBulkCString(c,server . slave_announce_ip ? server . slave_announce_ip : ""); matches++; } } while(0);;
    do { if (stringmatch(pattern,"replica-announce-ip",1)) { addReplyBulkCString(c,"replica-announce-ip"); addReplyBulkCString(c,server . slave_announce_ip ? server . slave_announce_ip : ""); matches++; } } while(0);;

     
    do { if (stringmatch(pattern,"maxmemory",1)) { ll2string(buf,sizeof(buf),server . maxmemory); addReplyBulkCString(c,"maxmemory"); addReplyBulkCString(c,buf); matches++; } } while(0);;
    do { if (stringmatch(pattern,"proto-max-bulk-len",1)) { ll2string(buf,sizeof(buf),server . proto_max_bulk_len); addReplyBulkCString(c,"proto-max-bulk-len"); addReplyBulkCString(c,buf); matches++; } } while(0);;
    do { if (stringmatch(pattern,"client-query-buffer-limit",1)) { ll2string(buf,sizeof(buf),server . client_max_querybuf_len); addReplyBulkCString(c,"client-query-buffer-limit"); addReplyBulkCString(c,buf); matches++; } } while(0);;
    do { if (stringmatch(pattern,"maxmemory-samples",1)) { ll2string(buf,sizeof(buf),server . maxmemory_samples); addReplyBulkCString(c,"maxmemory-samples"); addReplyBulkCString(c,buf); matches++; } } while(0);;
    do { if (stringmatch(pattern,"lfu-log-factor",1)) { ll2string(buf,sizeof(buf),server . lfu_log_factor); addReplyBulkCString(c,"lfu-log-factor"); addReplyBulkCString(c,buf); matches++; } } while(0);;
    do { if (stringmatch(pattern,"lfu-decay-time",1)) { ll2string(buf,sizeof(buf),server . lfu_decay_time); addReplyBulkCString(c,"lfu-decay-time"); addReplyBulkCString(c,buf); matches++; } } while(0);;
    do { if (stringmatch(pattern,"timeout",1)) { ll2string(buf,sizeof(buf),server . maxidletime); addReplyBulkCString(c,"timeout"); addReplyBulkCString(c,buf); matches++; } } while(0);;
    do { if (stringmatch(pattern,"active-defrag-threshold-lower",1)) { ll2string(buf,sizeof(buf),server . active_defrag_threshold_lower); addReplyBulkCString(c,"active-defrag-threshold-lower"); addReplyBulkCString(c,buf); matches++; } } while(0);;
    do { if (stringmatch(pattern,"active-defrag-threshold-upper",1)) { ll2string(buf,sizeof(buf),server . active_defrag_threshold_upper); addReplyBulkCString(c,"active-defrag-threshold-upper"); addReplyBulkCString(c,buf); matches++; } } while(0);;
    do { if (stringmatch(pattern,"active-defrag-ignore-bytes",1)) { ll2string(buf,sizeof(buf),server . active_defrag_ignore_bytes); addReplyBulkCString(c,"active-defrag-ignore-bytes"); addReplyBulkCString(c,buf); matches++; } } while(0);;
    do { if (stringmatch(pattern,"active-defrag-cycle-min",1)) { ll2string(buf,sizeof(buf),server . active_defrag_cycle_min); addReplyBulkCString(c,"active-defrag-cycle-min"); addReplyBulkCString(c,buf); matches++; } } while(0);;
    do { if (stringmatch(pattern,"active-defrag-cycle-max",1)) { ll2string(buf,sizeof(buf),server . active_defrag_cycle_max); addReplyBulkCString(c,"active-defrag-cycle-max"); addReplyBulkCString(c,buf); matches++; } } while(0);;
    do { if (stringmatch(pattern,"active-defrag-max-scan-fields",1)) { ll2string(buf,sizeof(buf),server . active_defrag_max_scan_fields); addReplyBulkCString(c,"active-defrag-max-scan-fields"); addReplyBulkCString(c,buf); matches++; } } while(0);;
    do { if (stringmatch(pattern,"auto-aof-rewrite-percentage",1)) { ll2string(buf,sizeof(buf),server . aof_rewrite_perc); addReplyBulkCString(c,"auto-aof-rewrite-percentage"); addReplyBulkCString(c,buf); matches++; } } while(0);;

    do { if (stringmatch(pattern,"auto-aof-rewrite-min-size",1)) { ll2string(buf,sizeof(buf),server . aof_rewrite_min_size); addReplyBulkCString(c,"auto-aof-rewrite-min-size"); addReplyBulkCString(c,buf); matches++; } } while(0);;

    do { if (stringmatch(pattern,"hash-max-ziplist-entries",1)) { ll2string(buf,sizeof(buf),server . hash_max_ziplist_entries); addReplyBulkCString(c,"hash-max-ziplist-entries"); addReplyBulkCString(c,buf); matches++; } } while(0);;

    do { if (stringmatch(pattern,"hash-max-ziplist-value",1)) { ll2string(buf,sizeof(buf),server . hash_max_ziplist_value); addReplyBulkCString(c,"hash-max-ziplist-value"); addReplyBulkCString(c,buf); matches++; } } while(0);;

    do { if (stringmatch(pattern,"stream-node-max-bytes",1)) { ll2string(buf,sizeof(buf),server . stream_node_max_bytes); addReplyBulkCString(c,"stream-node-max-bytes"); addReplyBulkCString(c,buf); matches++; } } while(0);;

    do { if (stringmatch(pattern,"stream-node-max-entries",1)) { ll2string(buf,sizeof(buf),server . stream_node_max_entries); addReplyBulkCString(c,"stream-node-max-entries"); addReplyBulkCString(c,buf); matches++; } } while(0);;

    do { if (stringmatch(pattern,"list-max-ziplist-size",1)) { ll2string(buf,sizeof(buf),server . list_max_ziplist_size); addReplyBulkCString(c,"list-max-ziplist-size"); addReplyBulkCString(c,buf); matches++; } } while(0);;

    do { if (stringmatch(pattern,"list-compress-depth",1)) { ll2string(buf,sizeof(buf),server . list_compress_depth); addReplyBulkCString(c,"list-compress-depth"); addReplyBulkCString(c,buf); matches++; } } while(0);;

    do { if (stringmatch(pattern,"set-max-intset-entries",1)) { ll2string(buf,sizeof(buf),server . set_max_intset_entries); addReplyBulkCString(c,"set-max-intset-entries"); addReplyBulkCString(c,buf); matches++; } } while(0);;

    do { if (stringmatch(pattern,"zset-max-ziplist-entries",1)) { ll2string(buf,sizeof(buf),server . zset_max_ziplist_entries); addReplyBulkCString(c,"zset-max-ziplist-entries"); addReplyBulkCString(c,buf); matches++; } } while(0);;

    do { if (stringmatch(pattern,"zset-max-ziplist-value",1)) { ll2string(buf,sizeof(buf),server . zset_max_ziplist_value); addReplyBulkCString(c,"zset-max-ziplist-value"); addReplyBulkCString(c,buf); matches++; } } while(0);;

    do { if (stringmatch(pattern,"hll-sparse-max-bytes",1)) { ll2string(buf,sizeof(buf),server . hll_sparse_max_bytes); addReplyBulkCString(c,"hll-sparse-max-bytes"); addReplyBulkCString(c,buf); matches++; } } while(0);;

    do { if (stringmatch(pattern,"lua-time-limit",1)) { ll2string(buf,sizeof(buf),server . lua_time_limit); addReplyBulkCString(c,"lua-time-limit"); addReplyBulkCString(c,buf); matches++; } } while(0);;
    do { if (stringmatch(pattern,"slowlog-log-slower-than",1)) { ll2string(buf,sizeof(buf),server . slowlog_log_slower_than); addReplyBulkCString(c,"slowlog-log-slower-than"); addReplyBulkCString(c,buf); matches++; } } while(0);;

    do { if (stringmatch(pattern,"latency-monitor-threshold",1)) { ll2string(buf,sizeof(buf),server . latency_monitor_threshold); addReplyBulkCString(c,"latency-monitor-threshold"); addReplyBulkCString(c,buf); matches++; } } while(0);;

    do { if (stringmatch(pattern,"slowlog-max-len",1)) { ll2string(buf,sizeof(buf),server . slowlog_max_len); addReplyBulkCString(c,"slowlog-max-len"); addReplyBulkCString(c,buf); matches++; } } while(0);;

    do { if (stringmatch(pattern,"port",1)) { ll2string(buf,sizeof(buf),server . port); addReplyBulkCString(c,"port"); addReplyBulkCString(c,buf); matches++; } } while(0);;
    do { if (stringmatch(pattern,"cluster-announce-port",1)) { ll2string(buf,sizeof(buf),server . cluster_announce_port); addReplyBulkCString(c,"cluster-announce-port"); addReplyBulkCString(c,buf); matches++; } } while(0);;
    do { if (stringmatch(pattern,"cluster-announce-bus-port",1)) { ll2string(buf,sizeof(buf),server . cluster_announce_bus_port); addReplyBulkCString(c,"cluster-announce-bus-port"); addReplyBulkCString(c,buf); matches++; } } while(0);;
    do { if (stringmatch(pattern,"tcp-backlog",1)) { ll2string(buf,sizeof(buf),server . tcp_backlog); addReplyBulkCString(c,"tcp-backlog"); addReplyBulkCString(c,buf); matches++; } } while(0);;
    do { if (stringmatch(pattern,"databases",1)) { ll2string(buf,sizeof(buf),server . dbnum); addReplyBulkCString(c,"databases"); addReplyBulkCString(c,buf); matches++; } } while(0);;
    do { if (stringmatch(pattern,"io-threads",1)) { ll2string(buf,sizeof(buf),server . io_threads_num); addReplyBulkCString(c,"io-threads"); addReplyBulkCString(c,buf); matches++; } } while(0);;
    do { if (stringmatch(pattern,"repl-ping-slave-period",1)) { ll2string(buf,sizeof(buf),server . repl_ping_slave_period); addReplyBulkCString(c,"repl-ping-slave-period"); addReplyBulkCString(c,buf); matches++; } } while(0);;
    do { if (stringmatch(pattern,"repl-ping-replica-period",1)) { ll2string(buf,sizeof(buf),server . repl_ping_slave_period); addReplyBulkCString(c,"repl-ping-replica-period"); addReplyBulkCString(c,buf); matches++; } } while(0);;
    do { if (stringmatch(pattern,"repl-timeout",1)) { ll2string(buf,sizeof(buf),server . repl_timeout); addReplyBulkCString(c,"repl-timeout"); addReplyBulkCString(c,buf); matches++; } } while(0);;
    do { if (stringmatch(pattern,"repl-backlog-size",1)) { ll2string(buf,sizeof(buf),server . repl_backlog_size); addReplyBulkCString(c,"repl-backlog-size"); addReplyBulkCString(c,buf); matches++; } } while(0);;
    do { if (stringmatch(pattern,"repl-backlog-ttl",1)) { ll2string(buf,sizeof(buf),server . repl_backlog_time_limit); addReplyBulkCString(c,"repl-backlog-ttl"); addReplyBulkCString(c,buf); matches++; } } while(0);;
    do { if (stringmatch(pattern,"maxclients",1)) { ll2string(buf,sizeof(buf),server . maxclients); addReplyBulkCString(c,"maxclients"); addReplyBulkCString(c,buf); matches++; } } while(0);;
    do { if (stringmatch(pattern,"watchdog-period",1)) { ll2string(buf,sizeof(buf),server . watchdog_period); addReplyBulkCString(c,"watchdog-period"); addReplyBulkCString(c,buf); matches++; } } while(0);;
    do { if (stringmatch(pattern,"slave-priority",1)) { ll2string(buf,sizeof(buf),server . slave_priority); addReplyBulkCString(c,"slave-priority"); addReplyBulkCString(c,buf); matches++; } } while(0);;
    do { if (stringmatch(pattern,"replica-priority",1)) { ll2string(buf,sizeof(buf),server . slave_priority); addReplyBulkCString(c,"replica-priority"); addReplyBulkCString(c,buf); matches++; } } while(0);;
    do { if (stringmatch(pattern,"slave-announce-port",1)) { ll2string(buf,sizeof(buf),server . slave_announce_port); addReplyBulkCString(c,"slave-announce-port"); addReplyBulkCString(c,buf); matches++; } } while(0);;
    do { if (stringmatch(pattern,"replica-announce-port",1)) { ll2string(buf,sizeof(buf),server . slave_announce_port); addReplyBulkCString(c,"replica-announce-port"); addReplyBulkCString(c,buf); matches++; } } while(0);;
    do { if (stringmatch(pattern,"min-slaves-to-write",1)) { ll2string(buf,sizeof(buf),server . repl_min_slaves_to_write); addReplyBulkCString(c,"min-slaves-to-write"); addReplyBulkCString(c,buf); matches++; } } while(0);;
    do { if (stringmatch(pattern,"min-replicas-to-write",1)) { ll2string(buf,sizeof(buf),server . repl_min_slaves_to_write); addReplyBulkCString(c,"min-replicas-to-write"); addReplyBulkCString(c,buf); matches++; } } while(0);;
    do { if (stringmatch(pattern,"min-slaves-max-lag",1)) { ll2string(buf,sizeof(buf),server . repl_min_slaves_max_lag); addReplyBulkCString(c,"min-slaves-max-lag"); addReplyBulkCString(c,buf); matches++; } } while(0);;
    do { if (stringmatch(pattern,"min-replicas-max-lag",1)) { ll2string(buf,sizeof(buf),server . repl_min_slaves_max_lag); addReplyBulkCString(c,"min-replicas-max-lag"); addReplyBulkCString(c,buf); matches++; } } while(0);;
    do { if (stringmatch(pattern,"hz",1)) { ll2string(buf,sizeof(buf),server . config_hz); addReplyBulkCString(c,"hz"); addReplyBulkCString(c,buf); matches++; } } while(0);;
    do { if (stringmatch(pattern,"cluster-node-timeout",1)) { ll2string(buf,sizeof(buf),server . cluster_node_timeout); addReplyBulkCString(c,"cluster-node-timeout"); addReplyBulkCString(c,buf); matches++; } } while(0);;
    do { if (stringmatch(pattern,"cluster-migration-barrier",1)) { ll2string(buf,sizeof(buf),server . cluster_migration_barrier); addReplyBulkCString(c,"cluster-migration-barrier"); addReplyBulkCString(c,buf); matches++; } } while(0);;
    do { if (stringmatch(pattern,"cluster-slave-validity-factor",1)) { ll2string(buf,sizeof(buf),server . cluster_slave_validity_factor); addReplyBulkCString(c,"cluster-slave-validity-factor"); addReplyBulkCString(c,buf); matches++; } } while(0);;
    do { if (stringmatch(pattern,"cluster-replica-validity-factor",1)) { ll2string(buf,sizeof(buf),server . cluster_slave_validity_factor); addReplyBulkCString(c,"cluster-replica-validity-factor"); addReplyBulkCString(c,buf); matches++; } } while(0);;
    do { if (stringmatch(pattern,"repl-diskless-sync-delay",1)) { ll2string(buf,sizeof(buf),server . repl_diskless_sync_delay); addReplyBulkCString(c,"repl-diskless-sync-delay"); addReplyBulkCString(c,buf); matches++; } } while(0);;
    do { if (stringmatch(pattern,"tcp-keepalive",1)) { ll2string(buf,sizeof(buf),server . tcpkeepalive); addReplyBulkCString(c,"tcp-keepalive"); addReplyBulkCString(c,buf); matches++; } } while(0);;

     
    do { if (stringmatch(pattern,"cluster-require-full-coverage",1)) { addReplyBulkCString(c,"cluster-require-full-coverage"); addReplyBulkCString(c,server . cluster_require_full_coverage ? "yes" : "no"); matches++; } } while(0);;

    do { if (stringmatch(pattern,"cluster-slave-no-failover",1)) { addReplyBulkCString(c,"cluster-slave-no-failover"); addReplyBulkCString(c,server . cluster_slave_no_failover ? "yes" : "no"); matches++; } } while(0);;

    do { if (stringmatch(pattern,"cluster-replica-no-failover",1)) { addReplyBulkCString(c,"cluster-replica-no-failover"); addReplyBulkCString(c,server . cluster_slave_no_failover ? "yes" : "no"); matches++; } } while(0);;

    do { if (stringmatch(pattern,"no-appendfsync-on-rewrite",1)) { addReplyBulkCString(c,"no-appendfsync-on-rewrite"); addReplyBulkCString(c,server . aof_no_fsync_on_rewrite ? "yes" : "no"); matches++; } } while(0);;

    do { if (stringmatch(pattern,"slave-serve-stale-data",1)) { addReplyBulkCString(c,"slave-serve-stale-data"); addReplyBulkCString(c,server . repl_serve_stale_data ? "yes" : "no"); matches++; } } while(0);;

    do { if (stringmatch(pattern,"replica-serve-stale-data",1)) { addReplyBulkCString(c,"replica-serve-stale-data"); addReplyBulkCString(c,server . repl_serve_stale_data ? "yes" : "no"); matches++; } } while(0);;

    do { if (stringmatch(pattern,"slave-read-only",1)) { addReplyBulkCString(c,"slave-read-only"); addReplyBulkCString(c,server . repl_slave_ro ? "yes" : "no"); matches++; } } while(0);;

    do { if (stringmatch(pattern,"replica-read-only",1)) { addReplyBulkCString(c,"replica-read-only"); addReplyBulkCString(c,server . repl_slave_ro ? "yes" : "no"); matches++; } } while(0);;

    do { if (stringmatch(pattern,"slave-ignore-maxmemory",1)) { addReplyBulkCString(c,"slave-ignore-maxmemory"); addReplyBulkCString(c,server . repl_slave_ignore_maxmemory ? "yes" : "no"); matches++; } } while(0);;

    do { if (stringmatch(pattern,"replica-ignore-maxmemory",1)) { addReplyBulkCString(c,"replica-ignore-maxmemory"); addReplyBulkCString(c,server . repl_slave_ignore_maxmemory ? "yes" : "no"); matches++; } } while(0);;

    do { if (stringmatch(pattern,"stop-writes-on-bgsave-error",1)) { addReplyBulkCString(c,"stop-writes-on-bgsave-error"); addReplyBulkCString(c,server . stop_writes_on_bgsave_err ? "yes" : "no"); matches++; } } while(0);;

    do { if (stringmatch(pattern,"daemonize",1)) { addReplyBulkCString(c,"daemonize"); addReplyBulkCString(c,server . daemonize ? "yes" : "no"); matches++; } } while(0);;
    do { if (stringmatch(pattern,"rdbcompression",1)) { addReplyBulkCString(c,"rdbcompression"); addReplyBulkCString(c,server . rdb_compression ? "yes" : "no"); matches++; } } while(0);;
    do { if (stringmatch(pattern,"rdbchecksum",1)) { addReplyBulkCString(c,"rdbchecksum"); addReplyBulkCString(c,server . rdb_checksum ? "yes" : "no"); matches++; } } while(0);;
    do { if (stringmatch(pattern,"activerehashing",1)) { addReplyBulkCString(c,"activerehashing"); addReplyBulkCString(c,server . activerehashing ? "yes" : "no"); matches++; } } while(0);;
    do { if (stringmatch(pattern,"activedefrag",1)) { addReplyBulkCString(c,"activedefrag"); addReplyBulkCString(c,server . active_defrag_enabled ? "yes" : "no"); matches++; } } while(0);;
    do { if (stringmatch(pattern,"protected-mode",1)) { addReplyBulkCString(c,"protected-mode"); addReplyBulkCString(c,server . protected_mode ? "yes" : "no"); matches++; } } while(0);;
    do { if (stringmatch(pattern,"gopher-enabled",1)) { addReplyBulkCString(c,"gopher-enabled"); addReplyBulkCString(c,server . gopher_enabled ? "yes" : "no"); matches++; } } while(0);;
    do { if (stringmatch(pattern,"io-threads-do-reads",1)) { addReplyBulkCString(c,"io-threads-do-reads"); addReplyBulkCString(c,server . io_threads_do_reads ? "yes" : "no"); matches++; } } while(0);;
    do { if (stringmatch(pattern,"repl-disable-tcp-nodelay",1)) { addReplyBulkCString(c,"repl-disable-tcp-nodelay"); addReplyBulkCString(c,server . repl_disable_tcp_nodelay ? "yes" : "no"); matches++; } } while(0);;

    do { if (stringmatch(pattern,"repl-diskless-sync",1)) { addReplyBulkCString(c,"repl-diskless-sync"); addReplyBulkCString(c,server . repl_diskless_sync ? "yes" : "no"); matches++; } } while(0);;

    do { if (stringmatch(pattern,"aof-rewrite-incremental-fsync",1)) { addReplyBulkCString(c,"aof-rewrite-incremental-fsync"); addReplyBulkCString(c,server . aof_rewrite_incremental_fsync ? "yes" : "no"); matches++; } } while(0);;

    do { if (stringmatch(pattern,"rdb-save-incremental-fsync",1)) { addReplyBulkCString(c,"rdb-save-incremental-fsync"); addReplyBulkCString(c,server . rdb_save_incremental_fsync ? "yes" : "no"); matches++; } } while(0);;

    do { if (stringmatch(pattern,"aof-load-truncated",1)) { addReplyBulkCString(c,"aof-load-truncated"); addReplyBulkCString(c,server . aof_load_truncated ? "yes" : "no"); matches++; } } while(0);;

    do { if (stringmatch(pattern,"aof-use-rdb-preamble",1)) { addReplyBulkCString(c,"aof-use-rdb-preamble"); addReplyBulkCString(c,server . aof_use_rdb_preamble ? "yes" : "no"); matches++; } } while(0);;

    do { if (stringmatch(pattern,"lazyfree-lazy-eviction",1)) { addReplyBulkCString(c,"lazyfree-lazy-eviction"); addReplyBulkCString(c,server . lazyfree_lazy_eviction ? "yes" : "no"); matches++; } } while(0);;

    do { if (stringmatch(pattern,"lazyfree-lazy-expire",1)) { addReplyBulkCString(c,"lazyfree-lazy-expire"); addReplyBulkCString(c,server . lazyfree_lazy_expire ? "yes" : "no"); matches++; } } while(0);;

    do { if (stringmatch(pattern,"lazyfree-lazy-server-del",1)) { addReplyBulkCString(c,"lazyfree-lazy-server-del"); addReplyBulkCString(c,server . lazyfree_lazy_server_del ? "yes" : "no"); matches++; } } while(0);;

    do { if (stringmatch(pattern,"slave-lazy-flush",1)) { addReplyBulkCString(c,"slave-lazy-flush"); addReplyBulkCString(c,server . repl_slave_lazy_flush ? "yes" : "no"); matches++; } } while(0);;

    do { if (stringmatch(pattern,"replica-lazy-flush",1)) { addReplyBulkCString(c,"replica-lazy-flush"); addReplyBulkCString(c,server . repl_slave_lazy_flush ? "yes" : "no"); matches++; } } while(0);;

    do { if (stringmatch(pattern,"dynamic-hz",1)) { addReplyBulkCString(c,"dynamic-hz"); addReplyBulkCString(c,server . dynamic_hz ? "yes" : "no"); matches++; } } while(0);;


     
    do { if (stringmatch(pattern,"maxmemory-policy",1)) { addReplyBulkCString(c,"maxmemory-policy"); addReplyBulkCString(c,configEnumGetNameOrUnknown(maxmemory_policy_enum,server . maxmemory_policy)); matches++; } } while(0);;

    do { if (stringmatch(pattern,"loglevel",1)) { addReplyBulkCString(c,"loglevel"); addReplyBulkCString(c,configEnumGetNameOrUnknown(loglevel_enum,server . verbosity)); matches++; } } while(0);;

    do { if (stringmatch(pattern,"supervised",1)) { addReplyBulkCString(c,"supervised"); addReplyBulkCString(c,configEnumGetNameOrUnknown(supervised_mode_enum,server . supervised_mode)); matches++; } } while(0);;

    do { if (stringmatch(pattern,"appendfsync",1)) { addReplyBulkCString(c,"appendfsync"); addReplyBulkCString(c,configEnumGetNameOrUnknown(aof_fsync_enum,server . aof_fsync)); matches++; } } while(0);;

    do { if (stringmatch(pattern,"syslog-facility",1)) { addReplyBulkCString(c,"syslog-facility"); addReplyBulkCString(c,configEnumGetNameOrUnknown(syslog_facility_enum,server . syslog_facility)); matches++; } } while(0);;
    ...
    if (stringmatch(pattern,"appendonly",1)) {
        ...
        addReplyBulkCString(c,server.aof_state == 0 ? "no" : "yes");
        matches++;
    }
...
void rewriteConfigMarkAsProcessed(struct rewriteConfigState *state, const char *option) {
    ...
    if (dictAdd(state->rewritten,opt,((void *)0)) != 0) sdsfree(opt);
}
...
struct rewriteConfigState *rewriteConfigReadOldFile(char *path) {
    ...
    if (fp == ((void *)0) && errno != 2) return ((void *)0);
    ...
    while(fgets(buf,1024+1,fp) != ((void *)0)) {
        ...
        if (line[0] == '#' || line[0] == '\0') {
            if (!state->has_tail && !strcmp(line,"# Generated by CONFIG REWRITE"))
                state->has_tail = 1;
...
void rewriteConfigRewriteLine(struct rewriteConfigState *state, const char *option, sds line, int force) {
    ...
    if (l) {
        ...
        listDelNode(l,ln);
        if (((l)->len) == 0) dictDelete(state->option_to_line,o);
...
void rewriteConfigRemoveOrphaned(struct rewriteConfigState *state) {
    ...
    while((de = dictNext(di)) != ((void *)0)) {
        ...
        if (dictFind(state->rewritten,option) == ((void *)0)) {
            serverLog(0,"Not rewritten option: %s", option);
            continue;
        }
...
int rewriteConfigOverwriteFile(char *configfile, sds content) {
    int retval = 0;
    int fd = open(configfile,02|0100,0644);
...
int rewriteConfig(char *path) {
    ...
    rewriteConfigStringOption(state,"pidfile",server.pidfile,"/var/run/redis.pid");
    rewriteConfigNumericalOption(state,"port",server.port,6379);
    rewriteConfigNumericalOption(state,"cluster-announce-port",server.cluster_announce_port,0);
    rewriteConfigNumericalOption(state,"cluster-announce-bus-port",server.cluster_announce_bus_port,0);
    rewriteConfigNumericalOption(state,"tcp-backlog",server.tcp_backlog,511);
    ...
    rewriteConfigNumericalOption(state,"tcp-keepalive",server.tcpkeepalive,300);
    rewriteConfigNumericalOption(state,"replica-announce-port",server.slave_announce_port,0);
    rewriteConfigEnumOption(state,"loglevel",server.verbosity,loglevel_enum,2);
    ...
    rewriteConfigStringOption(state,"syslog-ident",server.syslog_ident,"redis");
    rewriteConfigSyslogfacilityOption(state);
    rewriteConfigSaveOption(state);
    rewriteConfigUserOption(state);
    rewriteConfigNumericalOption(state,"databases",server.dbnum,16);
    rewriteConfigNumericalOption(state,"io-threads",server.dbnum,1);
    ...
    rewriteConfigStringOption(state,"replica-announce-ip",server.slave_announce_ip,((void *)0));
    ...
    rewriteConfigYesNoOption(state,"replica-serve-stale-data",server.repl_serve_stale_data,1);
    rewriteConfigYesNoOption(state,"replica-read-only",server.repl_slave_ro,1);
    rewriteConfigYesNoOption(state,"replica-ignore-maxmemory",server.repl_slave_ignore_maxmemory,1);
    rewriteConfigNumericalOption(state,"repl-ping-replica-period",server.repl_ping_slave_period,10);
    rewriteConfigNumericalOption(state,"repl-timeout",server.repl_timeout,60);
    rewriteConfigBytesOption(state,"repl-backlog-size",server.repl_backlog_size,(1024*1024));
    rewriteConfigBytesOption(state,"repl-backlog-ttl",server.repl_backlog_time_limit,(60*60));
    rewriteConfigYesNoOption(state,"repl-disable-tcp-nodelay",server.repl_disable_tcp_nodelay,0);
    rewriteConfigYesNoOption(state,"repl-diskless-sync",server.repl_diskless_sync,0);
    rewriteConfigNumericalOption(state,"repl-diskless-sync-delay",server.repl_diskless_sync_delay,5);
    rewriteConfigNumericalOption(state,"replica-priority",server.slave_priority,100);
    rewriteConfigNumericalOption(state,"min-replicas-to-write",server.repl_min_slaves_to_write,0);
    rewriteConfigNumericalOption(state,"min-replicas-max-lag",server.repl_min_slaves_max_lag,10);
    rewriteConfigRequirepassOption(state,"requirepass");
    rewriteConfigNumericalOption(state,"maxclients",server.maxclients,10000);
    rewriteConfigBytesOption(state,"maxmemory",server.maxmemory,0);
    rewriteConfigBytesOption(state,"proto-max-bulk-len",server.proto_max_bulk_len,(512ll*1024*1024));
    rewriteConfigBytesOption(state,"client-query-buffer-limit",server.client_max_querybuf_len,(1024*1024*1024));
    rewriteConfigEnumOption(state,"maxmemory-policy",server.maxmemory_policy,maxmemory_policy_enum,(7<<8));
    rewriteConfigNumericalOption(state,"maxmemory-samples",server.maxmemory_samples,5);
    rewriteConfigNumericalOption(state,"lfu-log-factor",server.lfu_log_factor,10);
    rewriteConfigNumericalOption(state,"lfu-decay-time",server.lfu_decay_time,1);
    rewriteConfigNumericalOption(state,"active-defrag-threshold-lower",server.active_defrag_threshold_lower,10);
    rewriteConfigNumericalOption(state,"active-defrag-threshold-upper",server.active_defrag_threshold_upper,100);
    rewriteConfigBytesOption(state,"active-defrag-ignore-bytes",server.active_defrag_ignore_bytes,(100<<20));
    rewriteConfigNumericalOption(state,"active-defrag-cycle-min",server.active_defrag_cycle_min,5);
    rewriteConfigNumericalOption(state,"active-defrag-cycle-max",server.active_defrag_cycle_max,75);
    rewriteConfigNumericalOption(state,"active-defrag-max-scan-fields",server.active_defrag_max_scan_fields,1000);
    rewriteConfigYesNoOption(state,"appendonly",server.aof_state != 0,0);
    rewriteConfigStringOption(state,"appendfilename",server.aof_filename,"appendonly.aof");
    rewriteConfigEnumOption(state,"appendfsync",server.aof_fsync,aof_fsync_enum,2);
    rewriteConfigYesNoOption(state,"no-appendfsync-on-rewrite",server.aof_no_fsync_on_rewrite,0);
    rewriteConfigNumericalOption(state,"auto-aof-rewrite-percentage",server.aof_rewrite_perc,100);
    rewriteConfigBytesOption(state,"auto-aof-rewrite-min-size",server.aof_rewrite_min_size,(64*1024*1024));
    rewriteConfigNumericalOption(state,"lua-time-limit",server.lua_time_limit,5000);
    rewriteConfigYesNoOption(state,"cluster-enabled",server.cluster_enabled,0);
    rewriteConfigStringOption(state,"cluster-config-file",server.cluster_configfile,"nodes.conf");
    rewriteConfigYesNoOption(state,"cluster-require-full-coverage",server.cluster_require_full_coverage,1);
    rewriteConfigYesNoOption(state,"cluster-replica-no-failover",server.cluster_slave_no_failover,0);
    rewriteConfigNumericalOption(state,"cluster-node-timeout",server.cluster_node_timeout,15000);
    rewriteConfigNumericalOption(state,"cluster-migration-barrier",server.cluster_migration_barrier,1);
    rewriteConfigNumericalOption(state,"cluster-replica-validity-factor",server.cluster_slave_validity_factor,10);
    rewriteConfigNumericalOption(state,"slowlog-log-slower-than",server.slowlog_log_slower_than,10000);
    rewriteConfigNumericalOption(state,"latency-monitor-threshold",server.latency_monitor_threshold,0);
    rewriteConfigNumericalOption(state,"slowlog-max-len",server.slowlog_max_len,128);
    rewriteConfigNotifykeyspaceeventsOption(state);
    rewriteConfigNumericalOption(state,"hash-max-ziplist-entries",server.hash_max_ziplist_entries,512);
    rewriteConfigNumericalOption(state,"hash-max-ziplist-value",server.hash_max_ziplist_value,64);
    rewriteConfigNumericalOption(state,"stream-node-max-bytes",server.stream_node_max_bytes,4096);
    rewriteConfigNumericalOption(state,"stream-node-max-entries",server.stream_node_max_entries,100);
    rewriteConfigNumericalOption(state,"list-max-ziplist-size",server.list_max_ziplist_size,-2);
    rewriteConfigNumericalOption(state,"list-compress-depth",server.list_compress_depth,0);
    rewriteConfigNumericalOption(state,"set-max-intset-entries",server.set_max_intset_entries,512);
    rewriteConfigNumericalOption(state,"zset-max-ziplist-entries",server.zset_max_ziplist_entries,128);
    rewriteConfigNumericalOption(state,"zset-max-ziplist-value",server.zset_max_ziplist_value,64);
    rewriteConfigNumericalOption(state,"hll-sparse-max-bytes",server.hll_sparse_max_bytes,3000);
    rewriteConfigYesNoOption(state,"activerehashing",server.activerehashing,1);
    rewriteConfigYesNoOption(state,"activedefrag",server.active_defrag_enabled,0);
    rewriteConfigYesNoOption(state,"protected-mode",server.protected_mode,1);
    rewriteConfigYesNoOption(state,"gopher-enabled",server.gopher_enabled,0);
    rewriteConfigYesNoOption(state,"io-threads-do-reads",server.io_threads_do_reads,0);
    rewriteConfigClientoutputbufferlimitOption(state);
    rewriteConfigNumericalOption(state,"hz",server.config_hz,10);
    rewriteConfigYesNoOption(state,"aof-rewrite-incremental-fsync",server.aof_rewrite_incremental_fsync,1);
    rewriteConfigYesNoOption(state,"rdb-save-incremental-fsync",server.rdb_save_incremental_fsync,1);
    rewriteConfigYesNoOption(state,"aof-load-truncated",server.aof_load_truncated,1);
    rewriteConfigYesNoOption(state,"aof-use-rdb-preamble",server.aof_use_rdb_preamble,1);
    rewriteConfigEnumOption(state,"supervised",server.supervised_mode,supervised_mode_enum,0);
    rewriteConfigYesNoOption(state,"lazyfree-lazy-eviction",server.lazyfree_lazy_eviction,0);
    rewriteConfigYesNoOption(state,"lazyfree-lazy-expire",server.lazyfree_lazy_expire,0);
    rewriteConfigYesNoOption(state,"lazyfree-lazy-server-del",server.lazyfree_lazy_server_del,0);
    rewriteConfigYesNoOption(state,"replica-lazy-flush",server.repl_slave_lazy_flush,0);
    rewriteConfigYesNoOption(state,"dynamic-hz",server.dynamic_hz,1);
...
((void *)0)
        ...
        if (rewriteConfig(server.configfile) == -1) {
            serverLog(3,"CONFIG REWRITE failed: %s", strerror(errno));
            addReplyErrorFormat(c,"Rewriting config file: %s", strerror(errno));
        } else {
            serverLog(3,"CONFIG REWRITE executed with success.");
            addReply(c,shared.ok);
        }
    } else {
