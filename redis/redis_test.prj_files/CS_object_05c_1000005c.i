...
robj *createObject(int type, void *ptr) {
    ...
    if (server.maxmemory_policy & (1<<1)) {
        o->lru = (LFUGetTimeInMinutes()<<8) | 5;
    } else {
        o->lru = LRU_CLOCK();
    }
    return o;
...
robj *makeObjectShared(robj *o) {
    ((o->refcount == 1)?(void)0 : (_serverAssert("o->refcount == 1","object.c",70),_exit(1)));
    o->refcount = 0x7fffffff;
    return o;
}
...
robj *createStringObjectFromLongLongWithOptions(long long value, int valueobj) {
    ...
    if (server.maxmemory == 0 ||
        !(server.maxmemory_policy & ((1<<0)|(1<<1))))
    {
    ...
    if (value >= 0 && value < 10000 && valueobj == 0) {
        incrRefCount(shared.integers[value]);
        o = shared.integers[value];
    } else {
        if (value >= (-0x7fffffffffffffffL - 1L) && value <= 0x7fffffffffffffffL) {
            o = createObject(0, ((void *)0));
            o->encoding = 1;
            o->ptr = (void*)((long)value);
        } else {
            o = createObject(0,sdsfromlonglong(value));
        }
    }
    return o;
}
...
robj *dupStringObject(const robj *o) {
    ...
    ((o->type == 0)?(void)0 : (_serverAssert("o->type == OBJ_STRING","object.c",196),_exit(1)));
    ...
    case 1:
        d = createObject(0, ((void *)0));
        d->encoding = 1;
        d->ptr = o->ptr;
        return d;
    default:
        _serverPanic("object.c",209,"Wrong encoding."),_exit(1);
        break;
    }
}
...
void freeListObject(robj *o) {
    if (o->encoding == 9) {
        ...
        _serverPanic("object.c",291,"Unknown list encoding type"),_exit(1);
    }
}
...
void freeSetObject(robj *o) {
    ...
    case 6:
        ...
        break;
    default:
        _serverPanic("object.c",304,"Unknown set encoding type"),_exit(1);
    }
}
...
void freeZsetObject(robj *o) {
    ...
    case 5:
        ...
        break;
    default:
        _serverPanic("object.c",321,"Unknown sorted set encoding"),_exit(1);
    }
}
...
void freeHashObject(robj *o) {
    ...
    case 5:
        ...
        break;
    default:
        _serverPanic("object.c",334,"Unknown hash encoding type"),_exit(1);
        break;
    }
}
...
void incrRefCount(robj *o) {
    if (o->refcount != 0x7fffffff) o->refcount++;
}
...
void decrRefCount(robj *o) {
    if (o->refcount == 1) {
        ...
        case 3: freeZsetObject(o); break;
        case 4: freeHashObject(o); break;
        case 5: freeModuleObject(o); break;
        case 6: freeStreamObject(o); break;
        default: _serverPanic("object.c",363,"Unknown object type"),_exit(1); break;
        }
        zfree(o);
    } else {
        if (o->refcount <= 0) _serverPanic("object.c",367,"decrRefCount against refcount <= 0"),_exit(1);
        if (o->refcount != 0x7fffffff) o->refcount--;
    }
}
...
int isSdsRepresentableAsLongLong(sds s, long long *llval) {
    return string2ll(s,sdslen(s),llval) ? 0 : -1;
}

int isObjectRepresentableAsLongLong(robj *o, long long *llval) {
    ((o->type == 0)?(void)0 : (_serverAssertWithInfo(((void *)0),o,"o->type == OBJ_STRING","object.c",409),_exit(1)));
    if (o->encoding == 1) {
...
robj *tryObjectEncoding(robj *o) {
    ...
    ((o->type == 0)?(void)0 : (_serverAssertWithInfo(((void *)0),o,"o->type == OBJ_STRING","object.c",440),_exit(1)));

    

 
    if (!(o->encoding == 0 || o->encoding == 8)) return o;
...
robj *getDecodedObject(robj *o) {
    ...
    if (o->type == 0 && o->encoding == 1) {
        ...
        _serverPanic("object.c",521,"Unknown encoding type"),_exit(1);
    }
}
...
int compareStringObjectsWithFlags(robj *a, robj *b, int flags) {
    ((a->type == 0 && b->type == 0)?(void)0 : (_serverAssertWithInfo(((void *)0),a,"a->type == OBJ_STRING && b->type == OBJ_STRING","object.c",537),_exit(1)));
    char bufa[128], bufb[128], *astr, *bstr;
    size_t alen, blen, minlen;

    if (a == b) return 0;
    if ((a->encoding == 0 || a->encoding == 8)) {
        astr = a->ptr;
        alen = sdslen(astr);
    } else {
...
int compareStringObjects(robj *a, robj *b) {
    return compareStringObjectsWithFlags(a,b,(1<<0));
}

 
int collateStringObjects(robj *a, robj *b) {
    return compareStringObjectsWithFlags(a,b,(1<<1));
}
...
size_t stringObjectLen(robj *o) {
    ((o->type == 0)?(void)0 : (_serverAssertWithInfo(((void *)0),o,"o->type == OBJ_STRING","object.c",594),_exit(1)));
    if ((o->encoding == 0 || o->encoding == 8)) {
        return sdslen(o->ptr);
    } else {
...
int getDoubleFromObject(const robj *o, double *target) {
    ...
    if (o == ((void *)0)) {
        ...
        ((o->type == 0)?(void)0 : (_serverAssertWithInfo(((void *)0),o,"o->type == OBJ_STRING","object.c",609),_exit(1)));
        if ((o->encoding == 0 || o->encoding == 8)) {
            errno = 0;
            ...
            if (sdslen(o->ptr) == 0 ||
                ...
                (errno == 34 &&
                    (value == (__builtin_huge_val ()) || value == -(__builtin_huge_val ()) || value == 0)) ||
                ( cs_isnan( (double) (value) ) ))
                return -1;
        } else if (o->encoding == 1) {
            value = (long)o->ptr;
        } else {
            _serverPanic("object.c",623,"Unknown string encoding"),_exit(1);
        }
    }
    *target = value;
    return 0;
...
int getDoubleFromObjectOrReply(client *c, robj *o, double *target, const char *msg) {
    double value;
    if (getDoubleFromObject(o, &value) != 0) {
        if (msg != ((void *)0)) {
...
int getLongDoubleFromObject(robj *o, long double *target) {
    ...
    if (o == ((void *)0)) {
        ...
        ((o->type == 0)?(void)0 : (_serverAssertWithInfo(((void *)0),o,"o->type == OBJ_STRING","object.c",651),_exit(1)));
        if ((o->encoding == 0 || o->encoding == 8)) {
            errno = 0;
            ...
            _serverPanic("object.c",665,"Unknown string encoding"),_exit(1);
        }
    }
    *target = value;
    return 0;
...
int getLongDoubleFromObjectOrReply(client *c, robj *o, long double *target, const char *msg) {
    long double value;
    if (getLongDoubleFromObject(o, &value) != 0) {
        if (msg != ((void *)0)) {
            addReplyError(c,(char*)msg);
        } else {
            addReplyError(c,"value is not a valid float");
...
int getLongLongFromObject(robj *o, long long *target) {
    ...
    if (o == ((void *)0)) {
        ...
        ((o->type == 0)?(void)0 : (_serverAssertWithInfo(((void *)0),o,"o->type == OBJ_STRING","object.c",692),_exit(1)));
        if ((o->encoding == 0 || o->encoding == 8)) {
            if (string2ll(o->ptr,sdslen(o->ptr),&value) == 0) return -1;
        } else if (o->encoding == 1) {
            value = (long)o->ptr;
        } else {
            _serverPanic("object.c",698,"Unknown string encoding"),_exit(1);
        }
    }
...
int getLongLongFromObjectOrReply(client *c, robj *o, long long *target, const char *msg) {
    long long value;
    if (getLongLongFromObject(o, &value) != 0) {
        if (msg != ((void *)0)) {
            addReplyError(c,(char*)msg);
        } else {
...
int getLongFromObjectOrReply(client *c, robj *o, long *target, const char *msg) {
    ...
    if (getLongLongFromObjectOrReply(c, o, &value, msg) != 0) return -1;
    if (value < (-0x7fffffffffffffffL - 1L) || value > 0x7fffffffffffffffL) {
        if (msg != ((void *)0)) {
            addReplyError(c,(char*)msg);
        } else {
...
char *strEncoding(int encoding) {
    ...
    case 9: return "quicklist";
    case 5: return "ziplist";
    case 6: return "intset";
    case 7: return "skiplist";
    case 8: return "embstr";
...
size_t objectComputeSize(robj *o, size_t sample_size) {
    ...
    if (o->type == 0) {
        ...
        } else if(o->encoding == 8) {
            asize = sdslen(o->ptr)+2+sizeof(*o);
        } else {
            _serverPanic("object.c",795,"Unknown string encoding"),_exit(1);
        }
    } else if (o->type == 1) {
        if (o->encoding == 9) {
            quicklist *ql = o->ptr;
        ...
        } else if (o->encoding == 5) {
            asize = sizeof(*o)+ziplistBlobLen(o->ptr);
        } else {
            _serverPanic("object.c",810,"Unknown list encoding"),_exit(1);
        }
    } else if (o->type == 2) {
        if (o->encoding == 2) {
            d = o->ptr;
            di = dictGetIterator(d);
            asize = sizeof(*o)+sizeof(dict)+(sizeof(struct dictEntry*)*((d)->ht[0]. size +(d)->ht[1]. size));
            while((de = dictNext(di)) != ((void *)0) && samples < sample_size) {
                ele = ((de)->key);
                elesize += sizeof(struct dictEntry) + sdsAllocSize(ele);
                samples++;
            }
            dictReleaseIterator(di);
            if (samples) asize += (double)elesize/samples*((d)->ht[0]. used+(d)->ht[1]. used);
        } else if (o->encoding == 6) {
            intset *is = o->ptr;
            asize = sizeof(*o)+sizeof(*is)+is->encoding*is->length;
        } else {
            _serverPanic("object.c",828,"Unknown set encoding"),_exit(1);
        }
    } else if (o->type == 3) {
        if (o->encoding == 5) {
            asize = sizeof(*o)+(ziplistBlobLen(o->ptr));
            ...
            asize = sizeof(*o)+sizeof(zset)+(sizeof(struct dictEntry*)*((d)->ht[0]. size +(d)->ht[1]. size));
            while(znode != ((void *)0) && samples < sample_size) {
                elesize += sdsAllocSize(znode->ele);
                elesize += sizeof(struct dictEntry) + je_malloc_usable_size(znode);
                samples++;
                znode = znode->level[0].forward;
            }
            if (samples) asize += (double)elesize/samples*((d)->ht[0]. used+(d)->ht[1]. used);
        } else {
            _serverPanic("object.c",846,"Unknown sorted set encoding"),_exit(1);
        }
    } else if (o->type == 4) {
        if (o->encoding == 5) {
            asize = sizeof(*o)+(ziplistBlobLen(o->ptr));
            ...
            _serverPanic("object.c",865,"Unknown hash encoding"),_exit(1);
        }
    } else if (o->type == 6) {
        stream *s = o->ptr;
        asize = sizeof(*o);
        ...
        if (mt->mem_usage != ((void *)0)) {
            asize = mt->mem_usage(mv->value);
        } else {
            asize = 0;
        }
    } else {
        _serverPanic("object.c",937,"Unknown object type"),_exit(1);
    }
    return asize;
}
...
struct redisMemOverhead *getMemoryOverheadData(void) {
    ...
    if (server.repl_backlog)
        mem += je_malloc_usable_size(server . repl_backlog);
    mh->repl_backlog = mem;
    mem_total += mem;
    ...
    mem += ((server . lua_scripts)->ht[0]. used+(server . lua_scripts)->ht[1]. used) * sizeof(dictEntry) +
        ((server . lua_scripts)->ht[0]. size +(server . lua_scripts)->ht[1]. size) * sizeof(dictEntry*);
    mem += ((server . repl_scriptcache_dict)->ht[0]. used+(server . repl_scriptcache_dict)->ht[1]. used) * sizeof(dictEntry) +
        ((server . repl_scriptcache_dict)->ht[0]. size +(server . repl_scriptcache_dict)->ht[1]. size) * sizeof(dictEntry*);
    if (((server . repl_scriptcache_fifo)->len) > 0) {
        mem += ((server . repl_scriptcache_fifo)->len) * (sizeof(listNode) + 
            sdsZmallocSize(((((server . repl_scriptcache_fifo)->head))->value)));
    }
    mh->lua_caches = mem;
    mem_total+=mem;
    ...
    for (j = 0; j < server.dbnum; j++) {
        ...
        long long keyscount = ((db->dict)->ht[0]. used+(db->dict)->ht[1]. used);
        ...
        mem = ((db->dict)->ht[0]. used+(db->dict)->ht[1]. used) * sizeof(dictEntry) +
              ((db->dict)->ht[0]. size +(db->dict)->ht[1]. size) * sizeof(dictEntry*) +
              ((db->dict)->ht[0]. used+(db->dict)->ht[1]. used) * sizeof(robj);
        mh->db[mh->num_dbs].overhead_ht_main = mem;
        mem_total+=mem;

        mem = ((db->expires)->ht[0]. used+(db->expires)->ht[1]. used) * sizeof(dictEntry) +
              ((db->expires)->ht[0]. size +(db->expires)->ht[1]. size) * sizeof(dictEntry*);
...
sds getMemoryDoctorReport(void) {
    ...
    if (mh->total_allocated < (1024*1024*5)) {
        ...
        if (((server . lua_scripts)->ht[0]. used+(server . lua_scripts)->ht[1]. used) > 1000) {
            many_scripts = 1;
            num_reports++;
        }
    }
...
void objectSetLRUOrLFU(robj *val, long long lfu_freq, long long lru_idle,
    ...
    if (server.maxmemory_policy & (1<<1)) {
        if (lfu_freq >= 0) {
            ((lfu_freq <= 255)?(void)0 : (_serverAssert("lfu_freq <= 255","object.c",1209),_exit(1)));
        ...
        if (lru_abs < 0)
            lru_abs = (lru_clock+(((1<<24)-1)/2)) % ((1<<24)-1);
        val->lru = lru_abs;
    }
}
...
((void *)0)
        ...
        for (int j = 3; j < c->argc; j++) {
                ...
                j+1 < c->argc)
            {
                ...
                if (samples == 0) samples = 0x7fffffffffffffffLL;;
                j++;  
            } else {
                addReply(c,shared.syntaxerr);
                return;
        ...
        size_t usage = objectComputeSize(((de)->v . val),samples);
        usage += sdsAllocSize(((de)->key));
        ...
        sds info = sdsempty();
        je_malloc_stats_print(inputCatSds, &info, ((void *)0));
        ...
        if (!je_mallctl("arenas.narenas", &narenas, &sz, ((void *)0), 0)) {
            sprintf(tmp, "arena.%d.purge", narenas);
            if (!je_mallctl(tmp, ((void *)0), 0, ((void *)0), 0)) {
