...
pthread_mutex_t lazyfree_objects_mutex = { { 0, 0, 0, 0, 0, 0, 0, { 0, 0 } } };

 
size_t lazyfreeGetPendingObjectsCount(void) {
    size_t aux;
    do { aux = (({ typeof(*(&lazyfree_objects)) __csonar_gcc_atomic_val; csonar_mutex_acquire( __csonar_gcc_atomic_mutex ); __csonar_gcc_atomic_val = (*(&lazyfree_objects)); csonar_mutex_release( __csonar_gcc_atomic_mutex ); (void)__csonar_gcc_atomic_val; __csonar_gcc_atomic_val; })); } while(0);
    return aux;
}
...
size_t lazyfreeGetFreeEffort(robj *obj) {
    if (obj->type == 1) {
        ...
        return ql->len;
    } else if (obj->type == 2 && obj->encoding == 2) {
        dict *ht = obj->ptr;
        return ((ht)->ht[0]. used+(ht)->ht[1]. used);
    } else if (obj->type == 3 && obj->encoding == 7){
        zset *zs = obj->ptr;
        return zs->zsl->length;
    } else if (obj->type == 4 && obj->encoding == 2) {
        dict *ht = obj->ptr;
        return ((ht)->ht[0]. used+(ht)->ht[1]. used);
    } else {
        return 1;  
...
int dbAsyncDelete(redisDb *db, robj *key) {
    ...
    if (de) {
        ...
        if (free_effort > 64 && val->refcount == 1) {
            (({ typeof(({ typeof(&lazyfree_objects) __csonar_ptr = (&lazyfree_objects); *__csonar_ptr += ((1)); *__csonar_ptr; })) __csonar_gcc_atomic_val; csonar_mutex_acquire( __csonar_gcc_atomic_mutex ); __csonar_gcc_atomic_val = (({ typeof(&lazyfree_objects) __csonar_ptr = (&lazyfree_objects); *__csonar_ptr += ((1)); *__csonar_ptr; })); csonar_mutex_release( __csonar_gcc_atomic_mutex ); (void)__csonar_gcc_atomic_val; __csonar_gcc_atomic_val; }));
            bioCreateBackgroundJob(2,val,((void *)0),((void *)0));
            do { if ((db->dict)->type ->valDup) (de)->v . val = (db->dict)->type ->valDup((db->dict)->privdata, ((void *)0)); else (de)->v . val = (((void *)0)); } while(0);
        }
    }
...
void freeObjAsync(robj *o) {
    ...
    if (free_effort > 64 && o->refcount == 1) {
        (({ typeof(({ typeof(&lazyfree_objects) __csonar_ptr = (&lazyfree_objects); *__csonar_ptr += ((1)); *__csonar_ptr; })) __csonar_gcc_atomic_val; csonar_mutex_acquire( __csonar_gcc_atomic_mutex ); __csonar_gcc_atomic_val = (({ typeof(&lazyfree_objects) __csonar_ptr = (&lazyfree_objects); *__csonar_ptr += ((1)); *__csonar_ptr; })); csonar_mutex_release( __csonar_gcc_atomic_mutex ); (void)__csonar_gcc_atomic_val; __csonar_gcc_atomic_val; }));
        bioCreateBackgroundJob(2,o,((void *)0),((void *)0));
    } else {
        decrRefCount(o);
    }
}
...
void emptyDbAsync(redisDb *db) {
    ...
    (({ typeof(({ typeof(&lazyfree_objects) __csonar_ptr = (&lazyfree_objects); *__csonar_ptr += ((((oldht1)->ht[0]. used+(oldht1)->ht[1]. used))); *__csonar_ptr; })) __csonar_gcc_atomic_val; csonar_mutex_acquire( __csonar_gcc_atomic_mutex ); __csonar_gcc_atomic_val = (({ typeof(&lazyfree_objects) __csonar_ptr = (&lazyfree_objects); *__csonar_ptr += ((((oldht1)->ht[0]. used+(oldht1)->ht[1]. used))); *__csonar_ptr; })); csonar_mutex_release( __csonar_gcc_atomic_mutex ); (void)__csonar_gcc_atomic_val; __csonar_gcc_atomic_val; }));
    bioCreateBackgroundJob(2,((void *)0),oldht1,oldht2);
}
...
void slotToKeyFlushAsync(void) {
    ...
    (({ typeof(({ typeof(&lazyfree_objects) __csonar_ptr = (&lazyfree_objects); *__csonar_ptr += ((old->numele)); *__csonar_ptr; })) __csonar_gcc_atomic_val; csonar_mutex_acquire( __csonar_gcc_atomic_mutex ); __csonar_gcc_atomic_val = (({ typeof(&lazyfree_objects) __csonar_ptr = (&lazyfree_objects); *__csonar_ptr += ((old->numele)); *__csonar_ptr; })); csonar_mutex_release( __csonar_gcc_atomic_mutex ); (void)__csonar_gcc_atomic_val; __csonar_gcc_atomic_val; }));
    bioCreateBackgroundJob(2,((void *)0),((void *)0),old);
}
...
void lazyfreeFreeDatabaseFromBioThread(dict *ht1, dict *ht2) {
    size_t numkeys = ((ht1)->ht[0]. used+(ht1)->ht[1]. used);
    dictRelease(ht1);
    dictRelease(ht2);
    (({ typeof(({ typeof(&lazyfree_objects) __csonar_ptr = (&lazyfree_objects); *__csonar_ptr -= ((numkeys)); *__csonar_ptr; })) __csonar_gcc_atomic_val; csonar_mutex_acquire( __csonar_gcc_atomic_mutex ); __csonar_gcc_atomic_val = (({ typeof(&lazyfree_objects) __csonar_ptr = (&lazyfree_objects); *__csonar_ptr -= ((numkeys)); *__csonar_ptr; })); csonar_mutex_release( __csonar_gcc_atomic_mutex ); (void)__csonar_gcc_atomic_val; __csonar_gcc_atomic_val; }));
}
...
void lazyfreeFreeSlotsMapFromBioThread(rax *rt) {
    ...
    raxFree(rt);
    (({ typeof(({ typeof(&lazyfree_objects) __csonar_ptr = (&lazyfree_objects); *__csonar_ptr -= ((len)); *__csonar_ptr; })) __csonar_gcc_atomic_val; csonar_mutex_acquire( __csonar_gcc_atomic_mutex ); __csonar_gcc_atomic_val = (({ typeof(&lazyfree_objects) __csonar_ptr = (&lazyfree_objects); *__csonar_ptr -= ((len)); *__csonar_ptr; })); csonar_mutex_release( __csonar_gcc_atomic_mutex ); (void)__csonar_gcc_atomic_val; __csonar_gcc_atomic_val; }));
}
