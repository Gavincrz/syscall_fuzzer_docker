...
void hashTypeTryConversion(robj *o, robj **argv, int start, int end) {
    ...
    if (o->encoding != 5) return;

    for (i = start; i <= end; i++) {
        if ((argv[i]->encoding == 0 || argv[i]->encoding == 8) &&
                           ...
                           long long *vll)
{
    ...
    ((o->encoding == 5)?(void)0 : (_serverAssert("o->encoding == OBJ_ENCODING_ZIPLIST","t_hash.c",65),_exit(1)));
    ...
    if (fptr != ((void *)0)) {
        ...
        if (fptr != ((void *)0)) {
            ...
            ((vptr != ((void *)0))?(void)0 : (_serverAssert("vptr != NULL","t_hash.c",74),_exit(1)));
        }
    }

    if (vptr != ((void *)0)) {
        ret = ziplistGet(vptr, vstr, vlen, vll);
        ((ret)?(void)0 : (_serverAssert("ret","t_hash.c",80),_exit(1)));
        return 0;
    }
...
sds hashTypeGetFromHashTable(robj *o, sds field) {
    ...
    ((o->encoding == 2)?(void)0 : (_serverAssert("o->encoding == OBJ_ENCODING_HT","t_hash.c",93),_exit(1)));
...
int hashTypeGetValue(robj *o, sds field, unsigned char **vstr, unsigned int *vlen, long long *vll) {
    if (o->encoding == 5) {
        *vstr = ((void *)0);
        ...
        _serverPanic("t_hash.c",122,"Unknown hash encoding"),_exit(1);
    }
    return -1;
}
...
robj *hashTypeGetValueObject(robj *o, sds field) {
    ...
    if (hashTypeGetValue(o,field,&vstr,&vlen,&vll) == -1) return ((void *)0);
...
size_t hashTypeGetValueLength(robj *o, sds field) {
    ...
    if (o->encoding == 5) {
        ...
        _serverPanic("t_hash.c",159,"Unknown hash encoding"),_exit(1);
    }
    return len;
}
...
int hashTypeExists(robj *o, sds field) {
    if (o->encoding == 5) {
        ...
        _serverPanic("t_hash.c",176,"Unknown hash encoding"),_exit(1);
    }
    return 0;
}
    ...
    if (o->encoding == 5) {
        ...
        if (fptr != ((void *)0)) {
            ...
            if (fptr != ((void *)0)) {
                ...
                vptr = ziplistNext(zl, fptr);
                ((vptr != ((void *)0))?(void)0 : (_serverAssert("vptr != NULL","t_hash.c",215),_exit(1)));
                update = 1;
        ...
        _serverPanic("t_hash.c",267,"Unknown hash encoding"),_exit(1);
    }

    
 
    if (flags & (1<<0) && field) sdsfree(field);
    if (flags & (1<<1) && value) sdsfree(value);
    return update;
}
...
int hashTypeDelete(robj *o, sds field) {
    ...
    if (o->encoding == 5) {
        ...
        if (dictDelete((dict*)o->ptr, field) == 0) {
            deleted = 1;
        ...
        _serverPanic("t_hash.c",305,"Unknown hash encoding"),_exit(1);
    }
    return deleted;
}
...
unsigned long hashTypeLength(const robj *o) {
    unsigned long length = (0x7fffffffffffffffL * 2UL + 1UL);

    if (o->encoding == 5) {
        length = ziplistLen(o->ptr) / 2;
    } else if (o->encoding == 2) {
        length = (((const dict*)o->ptr)->ht[0]. used+((const dict*)o->ptr)->ht[1]. used);
    } else {
        _serverPanic("t_hash.c",319,"Unknown hash encoding"),_exit(1);
    }
    return length;
}
...
hashTypeIterator *hashTypeInitIterator(robj *subject) {
    ...
    if (hi->encoding == 5) {
        ...
        _serverPanic("t_hash.c",335,"Unknown hash encoding"),_exit(1);
    }
    return hi;
}
...
int hashTypeNext(hashTypeIterator *hi) {
    if (hi->encoding == 5) {
        ...
        if (fptr == ((void *)0)) {
            ...
            ((vptr == ((void *)0))?(void)0 : (_serverAssert("vptr == NULL","t_hash.c",359),_exit(1)));
            fptr = ziplistIndex(zl, 0);
        } else {
             
            ((vptr != ((void *)0))?(void)0 : (_serverAssert("vptr != NULL","t_hash.c",363),_exit(1)));
        ...
        vptr = ziplistNext(zl, fptr);
        ((vptr != ((void *)0))?(void)0 : (_serverAssert("vptr != NULL","t_hash.c",370),_exit(1)));

         
        hi->fptr = fptr;
        hi->vptr = vptr;
    } else if (hi->encoding == 2) {
        if ((hi->de = dictNext(hi->di)) == ((void *)0)) return -1;
    } else {
        _serverPanic("t_hash.c",378,"Unknown hash encoding"),_exit(1);
    }
    return 0;
}
                                ...
                                long long *vll)
{
    ...
    ((hi->encoding == 5)?(void)0 : (_serverAssert("hi->encoding == OBJ_ENCODING_ZIPLIST","t_hash.c",392),_exit(1)));

    if (what & 1) {
        ret = ziplistGet(hi->fptr, vstr, vlen, vll);
        ((ret)?(void)0 : (_serverAssert("ret","t_hash.c",396),_exit(1)));
    } else {
        ret = ziplistGet(hi->vptr, vstr, vlen, vll);
        ((ret)?(void)0 : (_serverAssert("ret","t_hash.c",399),_exit(1)));
    }
}
...
sds hashTypeCurrentFromHashTable(hashTypeIterator *hi, int what) {
    ((hi->encoding == 2)?(void)0 : (_serverAssert("hi->encoding == OBJ_ENCODING_HT","t_hash.c",407),_exit(1)));
...
void hashTypeCurrentObject(hashTypeIterator *hi, int what, unsigned char **vstr, unsigned int *vlen, long long *vll) {
    if (hi->encoding == 5) {
        ...
        *vlen = sdslen(ele);
        ...
        _serverPanic("t_hash.c",435,"Unknown hash encoding"),_exit(1);
    }
}
...
void hashTypeConvertZiplist(robj *o, int enc) {
    ((o->encoding == 5)?(void)0 : (_serverAssert("o->encoding == OBJ_ENCODING_ZIPLIST","t_hash.c",466),_exit(1)));
    ...
    if (enc == 5) {
        ...
        while (hashTypeNext(hi) != -1) {
            ...
            key = hashTypeCurrentObjectNewSds(hi,1);
            value = hashTypeCurrentObjectNewSds(hi,2);
            ret = dictAdd(dict, key, value);
            if (ret != 0) {
                serverLogHexDump(3,"ziplist with dup elements dump",
                    o->ptr,ziplistBlobLen(o->ptr));
                _serverPanic("t_hash.c",488,"Ziplist corruption detected"),_exit(1);
            }
        }
        ...
        _serverPanic("t_hash.c",496,"Unknown hash encoding"),_exit(1);
    }
}
...
void hashTypeConvert(robj *o, int enc) {
    if (o->encoding == 5) {
        ...
        _serverPanic("t_hash.c",504,"Not implemented"),_exit(1);
    } else {
        _serverPanic("t_hash.c",506,"Unknown hash encoding"),_exit(1);
    }
}
...
void hsetnxCommand(client *c) {
    ...
    if (hashTypeExists(o, c->argv[2]->ptr)) {
        ...
        hashTypeSet(o,c->argv[2]->ptr,c->argv[3]->ptr,0);
        addReply(c, shared.cone);
        signalModifiedKey(c->db,c->argv[1]);
        notifyKeyspaceEvent((1<<6),"hset",c->argv[1],c->db->id);
        server.dirty++;
    }
}
...
void hsetCommand(client *c) {
    ...
    for (i = 2; i < c->argc; i += 2)
        created += !hashTypeSet(o,c->argv[i]->ptr,c->argv[i+1]->ptr,0);
...
void hincrbyCommand(client *c) {
    ...
    if (getLongLongFromObjectOrReply(c,c->argv[3],&incr,((void *)0)) != 0) return;
    if ((o = hashTypeLookupWriteOrCreate(c,c->argv[1])) == ((void *)0)) return;
    if (hashTypeGetValue(o,c->argv[2]->ptr,&vstr,&vlen,&value) == 0) {
        if (vstr) {
    ...
    oldvalue = value;
    if ((incr < 0 && oldvalue < 0 && incr < ((-0x7fffffffffffffffLL - 1LL)-oldvalue)) ||
        (incr > 0 && oldvalue > 0 && incr > (0x7fffffffffffffffLL-oldvalue))) {
        addReplyError(c,"increment or decrement would overflow");
        return;
    }
    value += incr;
    new = sdsfromlonglong(value);
    hashTypeSet(o,c->argv[2]->ptr,new,(1<<1));
    addReplyLongLong(c,value);
    signalModifiedKey(c->db,c->argv[1]);
    notifyKeyspaceEvent((1<<6),"hincrby",c->argv[1],c->db->id);
    server.dirty++;
}
...
void hincrbyfloatCommand(client *c) {
    ...
    if (getLongDoubleFromObjectOrReply(c,c->argv[3],&incr,((void *)0)) != 0) return;
    if ((o = hashTypeLookupWriteOrCreate(c,c->argv[1])) == ((void *)0)) return;
    if (hashTypeGetValue(o,c->argv[2]->ptr,&vstr,&vlen,&ll) == 0) {
        if (vstr) {
    ...
    value += incr;
    if (( cs_isnan( (double) (value) ) ) || ( cs_isinf( (double) (value) ) )) {
    ...
    signalModifiedKey(c->db,c->argv[1]);
    notifyKeyspaceEvent((1<<6),"hincrbyfloat",c->argv[1],c->db->id);
    server.dirty++;
...
static void addHashFieldToReply(client *c, robj *o, sds field) {
    ...
    if (o->encoding == 5) {
        ...
        _serverPanic("t_hash.c",675,"Unknown hash encoding"),_exit(1);
    }
}
...
void hdelCommand(client *c) {
    ...
    if (deleted) {
        signalModifiedKey(c->db,c->argv[1]);
        notifyKeyspaceEvent((1<<6),"hdel",c->argv[1],c->db->id);
        if (keyremoved)
            notifyKeyspaceEvent((1<<2),"del",c->argv[1],
                                c->db->id);
...
static void addHashIteratorCursorToReply(client *c, hashTypeIterator *hi, int what) {
    if (hi->encoding == 5) {
        ...
        _serverPanic("t_hash.c",766,"Unknown hash encoding"),_exit(1);
    }
}
...
void genericHgetallCommand(client *c, int flags) {
    ...
    while (hashTypeNext(hi) != -1) {
        if (flags & 1) {
            addHashIteratorCursorToReply(c, hi, 1);
            count++;
        }
        if (flags & 2) {
            addHashIteratorCursorToReply(c, hi, 2);
            count++;
        }
    }
    ...
    if (flags & 1 && flags & 2) count /= 2;
    ((count == length)?(void)0 : (_serverAssert("count == length","t_hash.c",803),_exit(1)));
}
